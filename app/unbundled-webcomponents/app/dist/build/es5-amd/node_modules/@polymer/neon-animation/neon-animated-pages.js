define(["../polymer/polymer-legacy.js","../iron-resizable-behavior/iron-resizable-behavior.js","../iron-selector/iron-selectable.js","../polymer/lib/legacy/polymer-fn.js","../polymer/lib/legacy/polymer.dom.js","../polymer/lib/utils/html-tag.js","./neon-animation-runner-behavior.js"],function(_polymerLegacy,_ironResizableBehavior,_ironSelectable,_polymerFn,_polymerDom,_htmlTag,_neonAnimationRunnerBehavior){"use strict";function _templateObject_fa0e9590aa8a11eaabbff38461706b4f(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        position: relative;\n      }\n\n      :host > ::slotted(*) {\n        position: absolute;\n        top: 0;\n        left: 0;\n        bottom: 0;\n        right: 0;\n      }\n\n      :host > ::slotted(:not(.iron-selected):not(.neon-animating))\n       {\n        display: none !important;\n      }\n\n      :host > ::slotted(.neon-animating) {\n        pointer-events: none;\n      }\n    </style>\n\n    <slot id=\"content\"></slot>\n  "]);_templateObject_fa0e9590aa8a11eaabbff38461706b4f=function _templateObject_fa0e9590aa8a11eaabbff38461706b4f(){return data};return data}/**
...
*/(0,_polymerFn.Polymer)({_template:(0,_htmlTag.html)(_templateObject_fa0e9590aa8a11eaabbff38461706b4f()),is:"neon-animated-pages",behaviors:[_ironResizableBehavior.IronResizableBehavior,_ironSelectable.IronSelectableBehavior,_neonAnimationRunnerBehavior.NeonAnimationRunnerBehavior],properties:{activateEvent:{type:String,value:""},// if true, the initial page selection will also be animated according to
