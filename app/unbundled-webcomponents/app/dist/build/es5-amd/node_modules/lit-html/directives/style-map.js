...
// iteration.
previousStyleProperties.forEach(function(name){if(!(name in styleInfo)){previousStyleProperties.delete(name);if(-1===name.indexOf("-")){// eslint-disable-next-line @typescript-eslint/no-explicit-any
style[name]=null}else{style.removeProperty(name)}}});// Add or update properties
for(var name in styleInfo){previousStyleProperties.add(name);if(-1===name.indexOf("-")){// eslint-disable-next-line @typescript-eslint/no-explicit-any
