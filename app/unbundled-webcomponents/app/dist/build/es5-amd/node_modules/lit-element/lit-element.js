define(["exports","../lit-html/lib/shady-render.js","./lib/updating-element.js","./lib/decorators.js","../lit-html/lit-html.js","./lib/css-tag.js"],function(_exports,_shadyRender,_updatingElement,_decorators,_litHtml,_cssTag){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});var _exportNames={LitElement:!0,html:!0,svg:!0,TemplateResult:!0,SVGTemplateResult:!0};Object.defineProperty(_exports,"html",{enumerable:!0,get:function get(){return _litHtml.html}});Object.defineProperty(_exports,"svg",{enumerable:!0,get:function get(){return _litHtml.svg}});Object.defineProperty(_exports,"TemplateResult",{enumerable:!0,get:function get(){return _litHtml.TemplateResult}});Object.defineProperty(_exports,"SVGTemplateResult",{enumerable:!0,get:function get(){return _litHtml.SVGTemplateResult}});_exports.LitElement=void 0;Object.keys(_updatingElement).forEach(function(key){if("default"===key||"__esModule"===key)return;if(Object.prototype.hasOwnProperty.call(_exportNames,key))return;Object.defineProperty(_exports,key,{enumerable:!0,get:function get(){return _updatingElement[key]}})});Object.keys(_decorators).forEach(function(key){if("default"===key||"__esModule"===key)return;if(Object.prototype.hasOwnProperty.call(_exportNames,key))return;Object.defineProperty(_exports,key,{enumerable:!0,get:function get(){return _decorators[key]}})});Object.keys(_cssTag).forEach(function(key){if("default"===key||"__esModule"===key)return;if(Object.prototype.hasOwnProperty.call(_exportNames,key))return;Object.defineProperty(_exports,key,{enumerable:!0,get:function get(){return _cssTag[key]}})});/**
 * @license
...
// rendering
if(window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow){window.ShadyCSS.ScopingShim.prepareAdoptedCssText(styles.map(function(s){return s.cssText}),this.localName)}else if(_cssTag.supportsAdoptingStyleSheets){this.renderRoot.adoptedStyleSheets=styles.map(function(s){return babelHelpers.instanceof(s,CSSStyleSheet)?s:s.styleSheet})}else{// This must be done after rendering so the actual style insertion is done
// in `update`.
...
if(this.hasUpdated&&window.ShadyCSS!==void 0){window.ShadyCSS.styleElement(this)}}/**
     ...
     */},{key:"update",value:function update(changedProperties){var _this=this,templateResult=this.render();babelHelpers.get(babelHelpers.getPrototypeOf(LitElement.prototype),"update",this).call(this,changedProperties);// If render is not implemented by the component, don't call lit-html render
...
// priority.
if(this._needsShimAdoptedStyleSheets){this._needsShimAdoptedStyleSheets=!1;this.constructor._styles.forEach(function(s){var style=document.createElement("style");style.textContent=s.cssText;_this.renderRoot.appendChild(style)})}}/**
...
//     false)
this._styles=this._styles.map(function(s){if(babelHelpers.instanceof(s,CSSStyleSheet)&&!_cssTag.supportsAdoptingStyleSheets){// Flatten the cssText from the passed constructible stylesheet (or
// undetectable non-constructible stylesheet). The user might have
// expected to update their stylesheets over time, but the alternative
// is a crash.
var cssText=Array.prototype.slice.call(s.cssRules).reduce(function(css,rule){return css+rule.cssText},"");return(0,_cssTag.unsafeCSS)(cssText)}return s})}}]);return LitElement}(_updatingElement.UpdatingElement);/**
