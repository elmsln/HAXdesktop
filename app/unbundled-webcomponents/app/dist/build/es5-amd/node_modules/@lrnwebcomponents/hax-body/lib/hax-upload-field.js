define(["exports","../../simple-fields/lib/simple-fields-upload.js","../../utils/utils.js","./hax-store.js"],function(_exports,_simpleFieldsUpload,_utils,_haxStore){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxUploadField=void 0;var HaxUploadField=/*#__PURE__*/function(_winEventsElement){babelHelpers.inherits(HaxUploadField,_winEventsElement);/**
   ...
   */babelHelpers.createClass(HaxUploadField,[{key:"_fileAboutToUpload",value:function _fileAboutToUpload(e){if(!this.__allowUpload&&_haxStore.HAXStore){// cancel the event so we can jump in
