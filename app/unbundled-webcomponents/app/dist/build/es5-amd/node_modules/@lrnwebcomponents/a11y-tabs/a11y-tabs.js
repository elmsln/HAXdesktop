...
get:function get(){return[(0,_litElement.css)(_templateObject3_f96c1400aa8a11eaabbff38461706b4f())]}},{key:"haxProperties",get:function get(){return{canScale:!1,canPosition:!0,canEditSource:!1,gizmo:{title:"Tabs",description:"A set of tabs.",icon:"view-day",color:"grey",groups:["Content","Presentation","Tabs"]},settings:{quick:[{property:"disabled",title:"Disabled",inputMethod:"boolean"},{property:"hidden",title:"Hidden",inputMethod:"boolean"},{property:"sticky",title:"Sticky",desc:"Horizontal tabs stick to the top of the window when scrolling.",inputMethod:"boolean"}],configure:[{property:"disabled",title:"Disabled",inputMethod:"boolean"},{property:"hidden",title:"Hidden",inputMethod:"boolean"},{property:"sticky",title:"Sticky.",desc:"Horizontal tabs stick to the top of the window when scrolling.",inputMethod:"boolean"},{property:"layoutBreakpoint",title:"Layout Breakpoint",inputMethod:"Number",descripton:"Optional minimum breakpoint for horizontal layout of tabs. Default is unset (always horizontal). Setting `-1` forces vertical-only mode."},{property:"iconBreakpoint",title:"Icon Breakpoint",inputMethod:"Number",descripton:"Optional minimum breakpoint for showing tab text with icons. Default is always text with icons (0). Setting to -1 forces icon-only mode."},{slot:"",title:"Tabs",description:"A series of <a11y-tab/> elements.",inputMethod:"code-editor"}],advanced:[{property:"id",title:"Unique ID",inputMethod:"textfield"}]}}}// properties available to the custom element for data binding
   ...
   */},{key:"tag",get:function get(){return"a11y-tabs"}}]);function A11yTabs(){var _this;babelHelpers.classCallCheck(this,A11yTabs);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yTabs).call(this));_this.disabled=!1;_this.hidden=!1;_this.__tabs=[];return _this}/**
   ...
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabButton",value:function _tabButton(tab){var _this6=this;return(0,_litElement.html)(_templateObject4_f96c1400aa8a11eaabbff38461706b4f(),tab.id,tab.id,tab.id===this.activeTab&&!this.disabled?"active":"",function(e){return _this6._handleTab(tab)},tab.id===this.activeTab||tab.disabled||this.disabled,tab.flag,this._tabIcon(tab,"flagIcon"),this._tabLabel(tab),this._tabFlag(tab),this._tabIcon(tab,"icon"),this._tabTooltip(tab))}/**
   * makes tab flag
   *
   * @param {string} flag tab's flag
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabFlag",value:function _tabFlag(tab){return(0,_litElement.html)(_templateObject5_f96c1400aa8a11eaabbff38461706b4f(),!tab.flag,tab.flag)}/**
   * makes tab icon
   *
   * @param {string} icon tab's icon
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabIcon",value:function _tabIcon(tab,icon){return(0,_litElement.html)(_templateObject6_f96c1400aa8a11eaabbff38461706b4f(),!tab[icon],tab[icon],tab[flag])}/**
   * makes tab label
   *
   * @param {string} flag tab's flag
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabLabel",value:function _tabLabel(tab){return(0,_litElement.html)(_templateObject7_f96c1400aa8a11eaabbff38461706b4f(),tab.label)}/**
   * makes tab tooltip
   *
   ...
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabTooltip",value:function _tabTooltip(tab){return(0,_litElement.html)(_templateObject8_f96c1400aa8a11eaabbff38461706b4f(),tab.id,tab.label)}},{key:"iconsOnly",get:function get(){return this.iconBreakpoint&&1>(this.tabs||[]).filter(function(tab){return!tab.icon}).length&&this.responsiveWidth<this.iconBreakpoint}/**
