...
var gravityScrollTimer=null,maxStep=25,edgeSize=100,HaxBody=/*#__PURE__*/function(_SimpleColors){babelHelpers.inherits(HaxBody,_SimpleColors);babelHelpers.createClass(HaxBody,null,[{key:"styles",/**
   ...
   */get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody),"styles",this)),[(0,_litElement.css)(_templateObject_f8ecd1e0aa8a11eaabbff38461706b4f())])}/**
   * HTMLElement
...
for(var i in children){if(children[i].classList&&children[i]!==this.activeItem){children[i].classList.add("hax-mover")}}}/**
   * LitElement render
   */},{key:"render",value:function render(){return(0,_litElement.html)(_templateObject2_f8ecd1e0aa8a11eaabbff38461706b4f())}/**
