define(["exports","require","../../../lit-element/lit-element.js","../../utils/utils.js","../../../@polymer/polymer/lib/elements/custom-style.js"],function(_exports,_require,_litElement,_utils,_customStyle){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxTrayUpload=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject2_fbe6b0f0aa8a11eaabbff38461706b4f(){var data=babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          @import url(\"https://fonts.googleapis.com/css?family=Noto+Serif\");\n          vaadin-upload {\n              color: #ffffff;\n              display: block;\n            }\n            --vaadin-upload-buttons-primary: {\n              display: block;\n              width: 100%;\n              flex: unset;\n              -webkit-flex: unset;\n            }\n            --vaadin-upload-button-add: {\n              color: #000000;\n              display: block;\n              flex: unset;\n              -webkit-flex: unset;\n              text-align: center;\n            }\n            --vaadin-upload-drop-label: {\n              color: #ffffff;\n              display: block;\n              padding: 8px;\n            }\n            --vaadin-upload-drop-label-dragover: {\n              color: #ffffff;\n            }\n            --vaadin-upload-file-list: {\n              padding: 8px;\n              margin: 0;\n              color: #ffffff;\n            }\n            --vaadin-upload-file: {\n              color: #ffffff;\n            }\n          }\n        </style>\n      </custom-style>\n      <div class=\"add-area-content-wrapper\">\n        <div class=\"add-url-area\">\n          <simple-fields-field\n            id=\"url\"\n            label=\"URL\"\n            type=\"url\"\n            auto-validate=\"\"\n          ></simple-fields-field>\n          <div class=\"url-description\">\n            Add an existing resource / link\n          </div>\n        </div>\n        <div class=\"add-upload-area\">\n          <vaadin-upload\n            @upload-before=\"","\"\n            @upload-response=\"","\"\n            form-data-name=\"file-upload\"\n            id=\"fileupload\"\n          ></vaadin-upload>\n        </div>\n        <paper-button @click=\"","\" id=\"newassetconfigure\"\n          >Configure</paper-button\n        >\n      </div>\n    "]);_templateObject2_fbe6b0f0aa8a11eaabbff38461706b4f=function _templateObject2_fbe6b0f0aa8a11eaabbff38461706b4f(){return data};return data}function _templateObject_fbe6b0f0aa8a11eaabbff38461706b4f(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          font-family: var(--simple-fields-font-family, sans-serif);\n          line-height: var(--simple-fields-line-height, 22px);\n          color: var(--simple-fields-color, black);\n          background-color: var(--simple-fields-background-color, #fff);\n        }\n        vaadin-upload {\n          --lumo-font-family: var(--simple-fields-font-family, sans-serif);\n          --lumo-error-color: var(--simple-fields-error-color, #dd2c00);\n          --lumo-primary-font-color: var(--simple-fields-color, black);\n          --lumo-base-color: var(--simple-fields-background-color, #fff);\n          --lumo-primary-contrast-color: var(\n            --simple-fields-background-color,\n            #fff\n          );\n          --lumo-primary-color: var(--simple-fields-color, black);\n          --lumo-dark-primary-color: ar(--simple-fields-color, black);\n          --lumo-light-primary-color: var(--simple-fields-color, black);\n          --lumo-primary-text-color: var(--simple-fields-color, black);\n          --lumo-body-text-color: var(--simple-fields-color, black);\n          --lumo-header-text-color: var(--simple-fields-color, black);\n          --lumo-secondary-text-color: var(--simple-fields-color, black);\n          --lumo-disabled-text-color: var(--simple-fields-border-color, #999);\n          color: var(--simple-fields-color, black);\n          background-color: var(--simple-fields-background-color, #fff);\n          padding: 16px !important;\n          text-align: center;\n        }\n        vaadin-upload[dragover] {\n          border-color: var(\n            --hax-tray-panel-accent,\n            var(--hax-contextual-action-hover-color)\n          );\n        }\n        vaadin-upload-file {\n          --disabled-text-color: var(--simple-fields-border-color, #999);\n        }\n        paper-button {\n          text-transform: none;\n          margin: 8px 0;\n          color: var(--simple-colors-default-theme-grey-12, #000);\n          background-color: var(--simple-colors-default-theme-grey-2, #eee);\n          border: 1px solid var(--simple-colors-default-theme-grey-3, #dddddd);\n          display: block;\n          text-align: center;\n        }\n        paper-button:active,\n        paper-button:focus,\n        paper-button:hover {\n          color: var(\n            --hax-tray-panel-accent-text,\n            var(--simple-colors-default-theme-grey-1, #fff)\n          );\n          background-color: var(\n            --hax-tray-panel-accent,\n            var(--hax-contextual-action-hover-color)\n          );\n          border-color: var(\n            --hax-tray-panel-accent,\n            var(--hax-contextual-action-hover-color)\n          );\n          transition: all 0.5ms ease-in-out;\n        }\n        .add-area-content-wrapper {\n          padding: 0 4px;\n        }\n        .add-url-area,\n        .add-upload-area {\n          margin: 0;\n        }\n        .url-description {\n          letter-spacing: 1px;\n        }\n      "]);_templateObject_fbe6b0f0aa8a11eaabbff38461706b4f=function _templateObject_fbe6b0f0aa8a11eaabbff38461706b4f(){return data};return data}var HaxTrayUpload=/*#__PURE__*/function(_winEventsElement){babelHelpers.inherits(HaxTrayUpload,_winEventsElement);babelHelpers.createClass(HaxTrayUpload,null,[{key:"styles",get:function get(){return[(0,_litElement.css)(_templateObject_fbe6b0f0aa8a11eaabbff38461706b4f())]}/**
   ...
   * LitElement render
   */babelHelpers.createClass(HaxTrayUpload,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject2_fbe6b0f0aa8a11eaabbff38461706b4f(),this._fileAboutToUpload,this._fileUploadResponse,this.newAssetConfigure)}/**
