 ...
 */var SimpleFieldsUpload=/*#__PURE__*/function(_SimpleColors){babelHelpers.inherits(SimpleFieldsUpload,_SimpleColors);babelHelpers.createClass(SimpleFieldsUpload,null,[{key:"tag",get:function get(){return"simple-fields-upload"}},{key:"styles",get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUpload),"styles",this)),[(0,_litElement.css)(_templateObject_dacc93c0812711eb9b3b3bc8a337bd59())])}/**
   * HTMLElement life cycle
   */}]);function SimpleFieldsUpload(){var _this;babelHelpers.classCallCheck(this,SimpleFieldsUpload);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleFieldsUpload).call(this));_this.label=null;_this.noCamera=!1;_this.options=[];// @todo leave this off until we can do more testing
// the wiring is all there but the UI pattern is not
_this.noVoiceRecord=!0;return _this}/**
   * LitElement life cycle - render callback
   */babelHelpers.createClass(SimpleFieldsUpload,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject2_dacc93c0812711eb9b3b3bc8a337bd59(),!this.label,this.label,this.option,this.optionChanged,this.options,"url"!==this.option,this.value||"",this.valueChanged,"fileupload"!==this.option,this._fileAboutToUpload,this._fileUploadResponse,"selfie"!==this.option,"audio"!==this.option,!this.description,this.description)}},{key:"optionChanged",value:function optionChanged(e){this.option=e.detail.value;// make sure there's not null here, possible when dynamically  built
if(null==e.detail.value||"null"==e.detail.value){if(this.options&&this.options[0]&&this.options[0][0]&&this.options[0][0].value){this.option=this.options[0][0].value}}}},{key:"valueChanged",value:function valueChanged(e){this.value=e.detail.value}/**
   * LitElement life cycle - properties changed callback
   */},{key:"updated",value:function updated(changedProperties){var _this2=this;if(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUpload.prototype),"updated",this)){babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUpload.prototype),"updated",this).call(this,changedProperties)}changedProperties.forEach(function(oldValue,propName){// notify
if("value"==propName){_this2.dispatchEvent(new CustomEvent("value-changed",{detail:{value:_this2[propName]}}))}})}/**
   ...
   */value:function _fileAboutToUpload(e){this.dispatchEvent(new CustomEvent("upload-before",{bubbles:!0,cancelable:!0,composed:!1,detail:e.detail}))}/**
   * Respond to successful file upload, now inject url into url field and
   * do a gizmo guess from there!
   */},{key:"_fileUploadResponse",value:function _fileUploadResponse(e){// set the value of the url which will update our URL and notify
this.shadowRoot.querySelector("#url").value=item.url;this.dispatchEvent(new CustomEvent("upload-response",{bubbles:!0,cancelable:!0,composed:!1,detail:e.detail}))}/**
...
var options=[[{alt:"URL",icon:"icons:link",value:"url"}],[{alt:"Upload",icon:"icons:file-upload",value:"fileupload"}]];if(!navigator.mediaDevices||this.noCamera){this.shadowRoot.querySelector("#camerahole").style.display="none"}else{options.push([{alt:"Camera",icon:"image:photo-camera",value:"selfie"}])}if(!navigator.mediaDevices||this.noVoiceRecord){this.shadowRoot.querySelector("#voicerecorder").style.display="none"}else{/*options.push([
   ...
   * LitElement
   */},{key:"firstUpdated",value:function firstUpdated(changedProperties){var _this3=this;if(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUpload.prototype),"firstUpdated",this)){babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUpload.prototype),"firstUpdated",this).call(this,changedProperties)}// test on load for if we have a media device
...
if(this.value){this.option="url"}else{this.option="fileupload"}this.shadowRoot.querySelector("#picker").addEventListener("change",function(e){if(e&&e.detail&&"selfie"===e.detail.value)_this3._takeSelfie(e);if(e&&e.detail&&"audio"===e.detail.value)_this3._voiceRecorder(e)})}/**
   ...
   */},{key:"_resolveObjectPath",value:function _resolveObjectPath(path,obj){return path.split(".").reduce(function(prev,curr){return prev?prev[curr]:null},obj||self)}}],[{key:"properties",get:function get(){return{label:{type:String},description:{type:String},value:{type:String},option:{type:String},options:{type:Array},/**
       ...
       * No Voice Recording
       */noVoiceRecord:{type:Boolean,attribute:"no-voice-record"}}}}]);return SimpleFieldsUpload}(_simpleColors.SimpleColors);_exports.SimpleFieldsUpload=SimpleFieldsUpload;window.customElements.define(SimpleFieldsUpload.tag,SimpleFieldsUpload)});