define(["exports","../../../lit-element/lit-element.js","./hax-toolbar-item.js","../../simple-icon/lib/simple-icon-lite.js","./hax-store.js"],function(_exports,_litElement,_haxToolbarItem,_simpleIconLite,_haxStore){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxContextItem=void 0;function _templateObject3_096b7200812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        simple-icon-lite {\n          width: 10px;\n        }\n        :host([menu]) {\n          display: flex;\n        }\n      "]);_templateObject3_096b7200812d11eb9c332bb120816628=function _templateObject3_096b7200812d11eb9c332bb120816628(){return data};return data}function _templateObject2_096b7200812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral([" <simple-icon-lite icon=\"hax:expand-more\"></simple-icon-lite> "]);_templateObject2_096b7200812d11eb9c332bb120816628=function _templateObject2_096b7200812d11eb9c332bb120816628(){return data};return data}function _templateObject_096b7200812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        ?simple=\"","\"\n        ?disabled=\"","\"\n        ?light=\"","\"\n        ?circle=\"","\"\n        ?danger=\"","\"\n        ?action=\"","\"\n        ?mini=\"","\"\n        ?large=\"","\"\n        id=\"button\"\n        .height=\"","\"\n        icon=\"","\"\n        ?hidden=\"","\"\n        icon-class=\"","\"\n        @mousedown=\"","\"\n        @click=\"","\"\n        tooltip=\"","\"\n        tooltip-direction=\"","\"\n        ?default=\"","\"\n        ?menu=\"","\"\n      >\n        ","\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);_templateObject_096b7200812d11eb9c332bb120816628=function _templateObject_096b7200812d11eb9c332bb120816628(){return data};return data}/**
 * `hax-context-item`
 ...
 */var HaxContextItem=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(HaxContextItem,_LitElement);function HaxContextItem(){var _this;babelHelpers.classCallCheck(this,HaxContextItem);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxContextItem).call(this));_this.haxUIElement=!0;_this.simple=!1;// flag to use simple-icon for performance
_this.danger=!1;_this.light=!1;_this.action=!1;_this.large=!1;_this.disabled=!1;_this.more=!1;_this.mini=!1;_this.menu=!1;_this.direction="top";_this.icon="editor:text-fields";_this.iconClass="";_this.label="";_this.eventName="button";_this.inputMethod=null;_this.propertyToBind=null;_this.slotToBind=null;_this.default=!1;_this.value="";return _this}babelHelpers.createClass(HaxContextItem,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject_096b7200812d11eb9c332bb120816628(),this.simple,this.disabled,this.light,this.circle,this.danger,this.action,this.mini,this.large,this.height,this.icon,!this.icon,this.iconClass,this._storeSelection,this._fireEvent,this.label,this.direction,this.default,this.menu,this.more&&!this.disabled?(0,_litElement.html)(_templateObject2_096b7200812d11eb9c332bb120816628()):"")}},{key:"_storeSelection",/**
