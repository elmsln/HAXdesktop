define(["exports","../../../lit-element/lit-element.js","../../../lit-html/lib/render.js","../../../lit-html/directives/unsafe-html.js","./simple-popover-manager.js"],function(_exports,_litElement,_render,_unsafeHtml,_simplePopoverManager){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimplePopoverSelection=void 0;function _templateObject3_db6ea020812711eb9b3b3bc8a337bd59(){var data=babelHelpers.taggedTemplateLiteral(["<slot name=\"button\"></slot>"]);_templateObject3_db6ea020812711eb9b3b3bc8a337bd59=function _templateObject3_db6ea020812711eb9b3b3bc8a337bd59(){return data};return data}function _templateObject2_db6ea020812711eb9b3b3bc8a337bd59(){var data=babelHelpers.taggedTemplateLiteral(["",""]);_templateObject2_db6ea020812711eb9b3b3bc8a337bd59=function _templateObject2_db6ea020812711eb9b3b3bc8a337bd59(){return data};return data}function _templateObject_db6ea020812711eb9b3b3bc8a337bd59(){var data=babelHelpers.taggedTemplateLiteral(["","",""]);_templateObject_db6ea020812711eb9b3b3bc8a337bd59=function _templateObject_db6ea020812711eb9b3b3bc8a337bd59(){return data};return data}var SimplePopoverSelection=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(SimplePopoverSelection,_LitElement);function SimplePopoverSelection(){var _this;babelHelpers.classCallCheck(this,SimplePopoverSelection);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimplePopoverSelection).call(this));_this.disabled=!1;return _this}babelHelpers.createClass(SimplePopoverSelection,[{key:"openedToggle",value:function openedToggle(e){if(!this.disabled){this.opened=!this.opened}}},{key:"openedChanged",value:function openedChanged(state){var _this2=this;if(state){var div=document.createElement("div");(0,_render.render)(div,window.SimplePopoverManager.requestAvailability());var slot=this.querySelectorAll("[slot=\"options\"]");// account for nesting in a single option area
...
if(this.querySelector("[slot=\"style\"]")){var styleData=this.querySelector("[slot=\"style\"]").cloneNode(!0),style=document.createElement("style");style.innerHTML=styleData.innerHTML;content=(0,_litElement.html)(_templateObject_db6ea020812711eb9b3b3bc8a337bd59(),(0,_unsafeHtml.unsafeHTML)(div.innerHTML),(0,_unsafeHtml.unsafeHTML)(style.outerHTML))}else{content=(0,_litElement.html)(_templateObject2_db6ea020812711eb9b3b3bc8a337bd59(),(0,_unsafeHtml.unsafeHTML)(div.innerHTML))}(0,_render.render)(content,window.SimplePopoverManager.requestAvailability());// delay for render
