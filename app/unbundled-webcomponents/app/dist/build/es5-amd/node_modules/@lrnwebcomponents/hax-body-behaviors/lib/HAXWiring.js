 ...
 */_exports.HAXWiring=HAXWiring;var HAXElement=function HAXElement(SuperClass){return/*#__PURE__*/function(_SuperClass){babelHelpers.inherits(_class,_SuperClass);var _super=_createSuper(_class);function _class(){var _this2;babelHelpers.classCallCheck(this,_class);_this2=_super.call(this);_this2.HAXWiring=new HAXWiring;return _this2}babelHelpers.createClass(_class,[{key:"setHaxProperties",/**
     * Setter to bridge private haxProperties setter.
     * This is to then be implemented by the ready state of whatever is supplying the
     * properties in order to be able to bubble up the properties for a tag.
     ...
     * Return a haxProperties prototype / example structure
     */},{key:"prototypeHaxProperties",value:function prototypeHaxProperties(){return this.HAXWiring.prototypeHaxProperties()}}],[{key:"properties",get:function get(){return _objectSpread(_objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(_class),"properties",this)),{},{/**
         * haxProperties
