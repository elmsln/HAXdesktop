 ...
 */var HAXWiring=function HAXWiring(){var _this=this;babelHelpers.classCallCheck(this,HAXWiring);/**
     * haxProperties
     */this.haxProperties={type:"element",editingElement:"core",canScale:!1,canPosition:!1,canEditSource:!0,settings:{configure:[],advanced:[]},wipeSlot:{}};this.pathFromUrl=function(url){return url.substring(0,url.lastIndexOf("/")+1)};/**
...
// and clean up.
if("1"==props.api){if(babelHelpers.typeof(props.type)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.type="element"}if(babelHelpers.typeof(props.editingElement)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.editingElement="core"}if(babelHelpers.typeof(props.canPosition)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.canPosition=!0}if(babelHelpers.typeof(props.canScale)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.canScale=!0}if(babelHelpers.typeof(props.canEditSource)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.canEditSource=!1}if(babelHelpers.typeof(props.contentEditable)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.contentEditable=!1}if(babelHelpers.typeof(props.gizmo)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.gizmo=!1}else{// support possible dynamic import of iconset
// this would be if the user defined their own icons
if(babelHelpers.typeof(props.gizmo.iconLib)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var basePath;if(window.WCGlobalBasePath){basePath=window.WCGlobalBasePath}else{basePath=_this.pathFromUrl(decodeURIComponent(meta.url))+"../../../"}new Promise(function(res,rej){return _require.default(["".concat(basePath).concat(props.gizmo.iconLib)],res,rej)})}}// while not required, this is where all the raw power of this
// approach really lies since this wires properties/slots to HAX's
// ability to manipulate things via contextual menus
if(babelHelpers.typeof(props.settings)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(babelHelpers.typeof(props.settings.configure)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.settings.configure=[]}for(var i=0;i<props.settings.configure.length;i++){props.settings.configure[i]=_this.validateSetting(props.settings.configure[i]);if(!props.settings.configure[i]){props.settings.configure.splice(i,1)}}if(babelHelpers.typeof(props.settings.advanced)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.settings.advanced=[]}for(var _i=0;_i<props.settings.advanced.length;_i++){props.settings.advanced[_i]=_this.validateSetting(props.settings.advanced[_i]);if(!props.settings.advanced[_i]){props.settings.advanced.splice(_i,1)}}props=_this.standardAdvancedProps(props)}// support for advanced save options
if(babelHelpers.typeof(props.saveOptions)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.saveOptions={wipeSlot:!1}}// support for demoSchema
if(babelHelpers.typeof(props.demoSchema)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.demoSchema=[]}// fire event so we know they have been set for the store to collect
...
if(babelHelpers.typeof(setting.slot)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(babelHelpers.typeof(setting.slotWrapper)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){setting.slotWrapper="span"}if(babelHelpers.typeof(setting.slotAttributes)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){setting.slotAttributes={}}}return setting};/**
     ...
     */this.getHaxJSONSchema=function(type,haxProperties){var target=2<arguments.length&&arguments[2]!==void 0?arguments[2]:_this;if(babelHelpers.typeof(type)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){type="configure"}if(babelHelpers.typeof(haxProperties)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){haxProperties=target.haxProperties}var settings=haxProperties.settings[type],schema={$schema:"http://json-schema.org/schema#",title:"HAX "+type+" form schema",type:"object",properties:{}};schema.properties=new _simpleFields.SimpleFields().fieldsToSchema(settings);// support post processing of schema in order to allow for really
...
if(haxProperties.gizmo&&haxProperties.gizmo.tag&&window.customElements.get(haxProperties.gizmo.tag)){var tmp=document.createElement(haxProperties.gizmo.tag);if("function"===typeof tmp.postProcessgetHaxJSONSchema){schema=tmp.postProcessgetHaxJSONSchema(schema)}else{schema=target.postProcessgetHaxJSONSchema(schema)}}else{schema=target.postProcessgetHaxJSONSchema(schema)}return schema};/**
     ...
     */this._getHaxJSONSchemaProperty=function(settings){return new _simpleFields.SimpleFields().fieldsToSchema(settings)};/**
     * Convert input method to schema type
     */this.getHaxJSONSchemaType=function(inputMethod){var method=new _simpleFields.SimpleFields().fieldsConversion.inputMethod[inputMethod]||new _simpleFields.SimpleFields().fieldsConversion;return method&&method.defaultSettings&&method.defaultSettings.type?method.defaultSettings.type:"string"};/**
     * List valid input methods.
     */this.validHAXPropertyInputMethod=function(){var methods=Object.keys(new _simpleFields.SimpleFields().fieldsConversion.inputMethod);return methods};/**
 ...
 */_exports.HAXWiring=HAXWiring;var HAXElement=function HAXElement(SuperClass){return(/*#__PURE__*/function(_SuperClass){babelHelpers.inherits(_class,_SuperClass);function _class(){var _this2;babelHelpers.classCallCheck(this,_class);_this2=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(_class).call(this));_this2.HAXWiring=new HAXWiring;return _this2}babelHelpers.createClass(_class,[{key:"setHaxProperties",/**
     ...
     * This is to then be implemented by the ready state of whatever is supplying the
     * properties in order to be able to bubble up the properties for a tag.
     */value:function setHaxProperties(props){var tag=1<arguments.length&&arguments[1]!==void 0?arguments[1]:"",context=2<arguments.length&&arguments[2]!==void 0?arguments[2]:this;if(""==tag&&babelHelpers.typeof(this.tagName)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){tag=this.tagName.toLowerCase()}if(window.HaxStore&&null!=window.HaxStore.instance&&window.HaxStore.instance.ready){return this.HAXWiring.setHaxProperties(props,tag,context,!0)}else{// slow load environment, set listener and hold off of processing
window.addEventListener("hax-store-ready",this._haxStoreReady.bind(this));return this.HAXWiring.setHaxProperties(props,tag,context,!1)}}/**
     * Clean up
     ...
     * Internal helper for getHaxJSONSchema to buiild the properties object
     * correctly with support for recursive nesting thx to objects / arrays.
     */},{key:"_getHaxJSONSchemaProperty",value:function _getHaxJSONSchemaProperty(settings){return new _simpleFields.SimpleFields().fieldsToSchema(settings)}/**
...
window.HAXBehaviors=window.HAXBehaviors||{};window.HAXBehaviors.PropertiesBehaviors={properties:{/**
   ...
   * Internal helper for getHaxJSONSchema to buiild the properties object
   * correctly with support for recursive nesting thx to objects / arrays.
   */_getHaxJSONSchemaProperty:function _getHaxJSONSchemaProperty(settings){return new _simpleFields.SimpleFields().fieldsToSchema(settings)},/**
   * Convert input method to schedma type
