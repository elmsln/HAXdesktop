define(["exports","meta","require","../../../lit-element/lit-element.js","../../utils/utils.js","../../hax-body-behaviors/hax-body-behaviors.js","../../../undoer/undoer.js"],function(_exports,meta,_require,_litElement,_utils,_haxBodyBehaviors,_undoer){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.UndoerElement=_exports.HaxStore=void 0;meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);function _templateObject2_a70beb20afe111eab5c3b1e04e313b03(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "]);_templateObject2_a70beb20afe111eab5c3b1e04e313b03=function _templateObject2_a70beb20afe111eab5c3b1e04e313b03(){return data};return data}function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(Object(source),!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function _templateObject_a70beb20afe111eab5c3b1e04e313b03(){var data=babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <undoer-element></undoer-element>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"","\"\n        .params=\"","\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"","\"\n      ></iron-ajax>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"","\"\n        .debug=\"","\"\n      ></hal-9000>\n    "]);_templateObject_a70beb20afe111eab5c3b1e04e313b03=function _templateObject_a70beb20afe111eab5c3b1e04e313b03(){return data};return data}function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=babelHelpers.getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget)}else{result=Super.apply(this,arguments)}return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"===typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"===typeof Proxy)return!0;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return!0}catch(e){return!1}}/**
 * @element hax-store
 */var HaxStore=/*#__PURE__*/function(_winEventsElement){babelHelpers.inherits(HaxStore,_winEventsElement);var _super=_createSuper(HaxStore);babelHelpers.createClass(HaxStore,[{key:"render",/**
   * LitElement render
   */value:function render(){return(0,_litElement.html)(_templateObject_a70beb20afe111eab5c3b1e04e313b03(),this.appStore.url,this.appStore.params,this.__appStoreDataChanged,this.voiceRespondsTo,this.voiceDebug)}},{key:"__appStoreDataChanged",value:function __appStoreDataChanged(e){this.__appStoreData=e.detail.value}/**
   * convention
...
this._handleDynamicImports(items,haxAutoloader)}}// simple path from a url modifier
   ...
   * it came from.
   */},{key:"_handleDynamicImports",value:function(){var _handleDynamicImports2=babelHelpers.asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee(items,haxAutoloader){var _this2=this,basePath,i,CEClass;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:basePath=this.pathFromUrl(decodeURIComponent(meta.url));_context.t0=regeneratorRuntime.keys(items);case 2:if((_context.t1=_context.t0()).done){_context.next=13;break}i=_context.t1.value;if(window.customElements.get(i)){_context.next=9;break}_context.next=7;return new Promise(function(res,rej){return _require.default(["".concat(basePath,"../../../").concat(items[i])],res,rej)}).then(function(response){var hasClass=!1;for(var cVal in response){// get the custom element definition we used to add that file
var CEClass=response[cVal];if("function"===typeof CEClass.getHaxProperties){_this2.setHaxProperties(CEClass.getHaxProperties(),i);hasClass=!0}else if("function"===typeof CEClass.HAXWiring){_this2.setHaxProperties(CEClass.HAXWiring.getHaxProperties(),i);hasClass=!0}else if(CEClass.haxProperties){_this2.setHaxProperties(CEClass.haxProperties,i);hasClass=!0}}// fallback for things that don't export a class
if(!hasClass&&window.customElements.get(i)&&window.customElements.get(i).haxProperties){_this2.setHaxProperties(window.customElements.get(i).haxProperties,i)}}).catch(function(error){/* Error handling */console.warn(error)});case 7:_context.next=11;break;case 9:// get the custom element definition we used to add that file
...
haxAutoloader.appendChild(document.createElement(i))}case 11:_context.next=2;break;case 13:case"end":return _context.stop();}}},_callee,this)}));function _handleDynamicImports(_x,_x2){return _handleDynamicImports2.apply(this,arguments)}return _handleDynamicImports}()},{key:"_editModeChanged",value:function _editModeChanged(newValue){if(newValue&&this.globalPreferences.haxVoiceCommands&&this.__hal){this.__hal.auto=!0}else{this.__hal.auto=!1}}},{key:"_globalPreferencesChanged",value:function _globalPreferencesChanged(newValue,oldValue){// regardless of what it is, reflect it globally but only after setup
if(this.__storageDataProcessed&&newValue&&babelHelpers.typeof(newValue.haxVoiceCommands)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&window.HaxStore.ready){var storageData=this.storageData;storageData.globalPreferences=newValue;this.storageData=storageData;this._storageDataChanged(this.storageData);if(newValue.haxVoiceCommands&&this.editMode&&this.__hal){this.__hal.auto=!0}else{this.__hal.auto=!1}}}/**
...
if(["__ready","__appStoreData","haxAutoloader"].includes(propName)){loadAppStoreData=!0}if(["haxAutoloader","activeHaxBody","haxToast","haxExport","haxMap","haxPreferences","haxAppPicker","haxTray"].includes(propName)){// allow this to verify if everything is here or not
_this4._storePiecesAllHere(_this4.haxAutoloader,_this4.activeHaxBody,_this4.haxToast,_this4.haxExport,_this4.haxMap,_this4.haxPreferences,_this4.haxAppPicker,_this4.haxTray)}});if(loadAppStoreData){this._loadAppStoreData(this.__ready,this.__appStoreData,this.haxAutoloader)}}},{key:"_calculateActiveGizmo",value:function _calculateActiveGizmo(activeNode){if(null==activeNode){return null}for(var gizmoposition in this.gizmoList){var gizmo=this.gizmoList[gizmoposition];if(gizmo.tag===activeNode.tagName.toLowerCase()){return gizmo}}}/**
   * ready life cycle
...
try{var globalData=window.sessionStorage.getItem("haxUserData")?JSON.parse(window.sessionStorage.getItem("haxUserData")):{};this.storageData=globalData;this._storageDataChanged(this.storageData)}catch(e){}}else{try{var _globalData=window.localStorage.getItem("haxUserData")?JSON.parse(window.localStorage.getItem("haxUserData")):{};this.storageData=_globalData;this._storageDataChanged(this.storageData)}catch(e){}}}}},{key:"_storePiecesAllHere",value:function _storePiecesAllHere(haxAutoloader,activeHaxBody,haxToast,haxExport,haxMap,haxPreferences,haxAppPicker,haxTray){if(!this.__ready&&activeHaxBody&&haxAutoloader&&haxToast&&haxExport&&haxMap&&haxPreferences&&haxAppPicker&&haxTray){// send that hax store is ready to go so now we can setup the rest
...
pasteContent=(0,_utils.stripMSWord)(pasteContent);console.log(pasteContent);// edges that some things preserve empty white space needlessly
...
var range=window.HaxStore.getRange(),sel=window.HaxStore.getSelection(),newNodes=document.createElement("div");newNodes.innerHTML=newContent;if(range&&sel&&"function"===typeof range.deleteContents){range.deleteContents();while(newNodes.lastChild){range.insertNode(newNodes.lastChild)}}}catch(e){console.warn(e)}}}},{key:"__validTags",value:function __validTags(){return["p","div","span","table","caption","sup","sub","u","strike","tr","th","td","ol","ul","li","a","strong","kbd","em","i","b","hr","h1","h2","h3","h4","h5","h6","blockquote","code","figure","img","iframe","video","audio","section","grid-plate","template","webview"]}},{key:"__validGizmoTypes",value:function __validGizmoTypes(){return["data","video","audio","text","link","file","pdf","image","csv","doc","archive","markdown","html","wikipedia","content","text","inline","*"]}/**
   ...
   */get:function get(){return[(0,_litElement.css)(_templateObject2_a70beb20afe111eab5c3b1e04e313b03())]}},{key:"tag",get:function get(){return"hax-store"}/**
   * LitElement / popular convention
   */},{key:"properties",get:function get(){return _objectSpread(_objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(HaxStore),"properties",this)),{},{openDrawer:{type:Object},voiceDebug:{type:Boolean,attribute:"voice-debug"},activeGizmo:{type:Object},voiceRespondsTo:{type:String,attribute:"voice-responses-to"},/**
       * skipHAXConfirmation
...
_this7.gizmoList=babelHelpers.toConsumableArray(gizmoList);window.HaxStore.write("gizmoList",gizmoList,_this7)},10)}}/**
   ...
   */},{key:"haxSchemaFromTag",value:function haxSchemaFromTag(tag){if(this.elementList&&this.elementList[tag]){return this.elementList[tag]}return{}}/**
...
var attr="string"===typeof value||"number"===typeof value;this._internalSet(value,attr)},get:function get(){var value=this._undoer.data.value;return value}}]);return UndoerElement}(/*#__PURE__*/babelHelpers.wrapNativeSuper(HTMLElement));_exports.UndoerElement=UndoerElement;window.customElements.define("undoer-element",UndoerElement)});