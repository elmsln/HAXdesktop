define(["exports","meta","require","../../../lit-element/lit-element.js","../../utils/utils.js","../../hax-body-behaviors/hax-body-behaviors.js","../../../undoer/undoer.js"],function(_exports,meta,_require,_litElement,_utils,_haxBodyBehaviors,_undoer){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.UndoerElement=_exports.HaxStore=void 0;meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);function _templateObject2_fbb71570aa8a11eaabbff38461706b4f(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "]);_templateObject2_fbb71570aa8a11eaabbff38461706b4f=function _templateObject2_fbb71570aa8a11eaabbff38461706b4f(){return data};return data}function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(Object(source),!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function _templateObject_fbb71570aa8a11eaabbff38461706b4f(){var data=babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <undoer-element></undoer-element>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"","\"\n        .params=\"","\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"","\"\n      ></iron-ajax>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"","\"\n        .debug=\"","\"\n      ></hal-9000>\n    "]);_templateObject_fbb71570aa8a11eaabbff38461706b4f=function _templateObject_fbb71570aa8a11eaabbff38461706b4f(){return data};return data}/**
 * @element hax-store
 */var HaxStore=/*#__PURE__*/function(_winEventsElement){babelHelpers.inherits(HaxStore,_winEventsElement);babelHelpers.createClass(HaxStore,[{key:"render",/**
   * LitElement render
   */value:function render(){return(0,_litElement.html)(_templateObject_fbb71570aa8a11eaabbff38461706b4f(),this.appStore.url,this.appStore.params,this.__appStoreDataChanged,this.voiceRespondsTo,this.voiceDebug)}},{key:"__appStoreDataChanged",value:function __appStoreDataChanged(e){this.__appStoreData=e.detail.value}/**
   * convention
...
var range=window.HaxStore.getRange(),sel=window.HaxStore.getSelection(),newNodes=document.createElement("div");newNodes.innerHTML=newContent;if(range&&sel&&"function"===typeof range.deleteContents){range.deleteContents();while(newNodes.lastChild){range.insertNode(newNodes.lastChild)}}}catch(e){console.warn(e)}}}},{key:"__validTags",value:function __validTags(){return["p","div","span","table","caption","sup","sub","u","strike","tr","th","td","ol","ul","li","a","strong","kbd","em","i","b","hr","h1","h2","h3","h4","h5","h6","blockquote","code","figure","img","iframe","video","audio","section","grid-plate","template","webview"]}},{key:"__validGizmoTypes",value:function __validGizmoTypes(){return["data","video","audio","text","link","file","pdf","image","csv","doc","archive","markdown","html","wikipedia","content","text","inline","*"]}/**
   ...
   */get:function get(){return[(0,_litElement.css)(_templateObject2_fbb71570aa8a11eaabbff38461706b4f())]}},{key:"tag",get:function get(){return"hax-store"}/**
