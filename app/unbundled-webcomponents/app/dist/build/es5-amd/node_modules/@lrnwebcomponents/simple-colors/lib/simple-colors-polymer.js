define(["exports","../../../@polymer/polymer/polymer-element.js","../../simple-colors-shared-styles/simple-colors-shared-styles.js","./simple-colors-shared-styles-polymer.js"],function(_exports,_polymerElement,_simpleColorsSharedStyles,_simpleColorsSharedStylesPolymer){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleColorsPolymer=void 0;function _templateObject_a797fe80afe111eab5c3b1e04e313b03(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style include=\"simple-colors-shared-styles-polymer\"></style>\n      <slot></slot>\n    "]);_templateObject_a797fe80afe111eab5c3b1e04e313b03=function _templateObject_a797fe80afe111eab5c3b1e04e313b03(){return data};return data}function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=babelHelpers.getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget)}else{result=Super.apply(this,arguments)}return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"===typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"===typeof Proxy)return!0;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return!0}catch(e){return!1}}/**
 * `simple-colors-polymer`
 * shared set of styles for Polymer @lrnwebcomponents
 *
 * @polymer
 * @element simple-colors-polymer
 */var SimpleColorsPolymer=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(SimpleColorsPolymer,_PolymerElement);var _super=_createSuper(SimpleColorsPolymer);babelHelpers.createClass(SimpleColorsPolymer,null,[{key:"template",// render function
get:function get(){return(0,_polymerElement.html)(_templateObject_a797fe80afe111eab5c3b1e04e313b03())}// properties available to the custom element for data binding
       ...
       * make the default theme dark?
       */colors:{name:"colors",type:Object,value:window.SimpleColorsSharedStyles.colors,notify:!0}}}},{key:"tag",get:function get(){return"simple-colors-polymer"}}]);function SimpleColorsPolymer(){var _this;babelHelpers.classCallCheck(this,SimpleColorsPolymer);_this=_super.call(this);_this.__utils=window.SimpleColorsSharedStyles.requestAvailability();_this.colors=window.SimpleColorsSharedStyles.colors;return _this}/**
   * gets the current shade
   *
   * @param {string} the shade
   * @param {number} the inverted shade
   */babelHelpers.createClass(SimpleColorsPolymer,[{key:"invertShade",value:function invertShade(shade){return this.__utils.invertShade(shade)}/**
   ...
   */},{key:"isContrastCompliant",value:function isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return this.__utils.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}]);return SimpleColorsPolymer}(_polymerElement.PolymerElement);_exports.SimpleColorsPolymer=SimpleColorsPolymer;window.customElements.define(SimpleColorsPolymer.tag,SimpleColorsPolymer)});