define(["exports","../../../@polymer/polymer/polymer-element.js","../../simple-colors-shared-styles/simple-colors-shared-styles.js","./simple-colors-shared-styles-polymer.js"],function(_exports,_polymerElement,_simpleColorsSharedStyles,_simpleColorsSharedStylesPolymer){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleColorsPolymer=void 0;function _templateObject_da693e10812711eb9b3b3bc8a337bd59(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style include=\"simple-colors-shared-styles-polymer\"></style>\n      <slot></slot>\n    "]);_templateObject_da693e10812711eb9b3b3bc8a337bd59=function _templateObject_da693e10812711eb9b3b3bc8a337bd59(){return data};return data}/**
 * `simple-colors-polymer`
 * shared set of styles for Polymer @lrnwebcomponents
 *
 * @polymer
 * @element simple-colors-polymer
 */var SimpleColorsPolymer=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(SimpleColorsPolymer,_PolymerElement);babelHelpers.createClass(SimpleColorsPolymer,null,[{key:"template",// render function
get:function get(){return(0,_polymerElement.html)(_templateObject_da693e10812711eb9b3b3bc8a337bd59())}// properties available to the custom element for data binding
       ...
       * make the default theme dark?
       */colors:{name:"colors",type:Object,value:window.SimpleColorsSharedStyles.colors,notify:!0}}}},{key:"tag",get:function get(){return"simple-colors-polymer"}}]);function SimpleColorsPolymer(){var _this;babelHelpers.classCallCheck(this,SimpleColorsPolymer);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleColorsPolymer).call(this));_this.__utils=window.SimpleColorsSharedStyles.requestAvailability();_this.colors=window.SimpleColorsSharedStyles.colors;return _this}/**
