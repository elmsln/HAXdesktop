define(["exports","../../../lit-element/lit-element.js","../simple-picker.js"],function(_exports,_litElement,_simplePicker){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleSymbolPicker=void 0;function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(Object(source),!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function _templateObject_db4b60b0812711eb9b3b3bc8a337bd59(){var data=babelHelpers.taggedTemplateLiteral(["\n        simple-picker-option {\n          justify-content: space-around;\n        }\n      "]);_templateObject_db4b60b0812711eb9b3b3bc8a337bd59=function _templateObject_db4b60b0812711eb9b3b3bc8a337bd59(){return data};return data}/**
 ...
 */var SimpleSymbolPicker=/*#__PURE__*/function(_SimplePicker){babelHelpers.inherits(SimpleSymbolPicker,_SimplePicker);babelHelpers.createClass(SimpleSymbolPicker,null,[{key:"styles",//styles function
get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleSymbolPicker),"styles",this)),[(0,_litElement.css)(_templateObject_db4b60b0812711eb9b3b3bc8a337bd59())])}// properties available to the custom element for data binding
},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(SimpleSymbolPicker),"properties",this),{/**
       * Symbol types to include
       */symbolTypes:{name:"symbolTypes",type:Array}})}/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */},{key:"tag",get:function get(){return"simple-symbol-picker"}}]);function SimpleSymbolPicker(){var _this;babelHelpers.classCallCheck(this,SimpleSymbolPicker);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleSymbolPicker).call(this));_this.icon="editor:functions";_this.label="Symbol";_this.symbolTypes=["symbols","math","characters","greek","misc"];_this.titleAsHtml=!0;return _this}/**
   * LitElement life cycle - ready callback
   */babelHelpers.createClass(SimpleSymbolPicker,[{key:"firstUpdated",value:function firstUpdated(changedProperties){if(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleSymbolPicker.prototype),"firstUpdated",this)){babelHelpers.get(babelHelpers.getPrototypeOf(SimpleSymbolPicker.prototype),"firstUpdated",this).call(this,changedProperties)}var optData=[{alt:null,icon:this.icon,value:null}];this.symbolTypes.forEach(function(type){return window.SimplePickerSymbols[type].forEach(function(symbol){return optData.push(symbol)})});optData=this._setPickerOptions(optData);this.options=optData}/**
