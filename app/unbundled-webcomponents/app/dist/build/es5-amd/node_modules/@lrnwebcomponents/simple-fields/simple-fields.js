 ...
 */var SimpleFields=/*#__PURE__*/function(_SimpleFieldsLite){babelHelpers.inherits(SimpleFields,_SimpleFieldsLite);var _super=_createSuper(SimpleFields);babelHelpers.createClass(SimpleFields,[{key:"render",// render function
value:function render(){return(0,_litElement.html)(_templateObject_a4e6c130afe111eab5c3b1e04e313b03())}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFields),"styles",this)),[(0,_litElement.css)(_templateObject2_a4e6c130afe111eab5c3b1e04e313b03())])}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
},{key:"properties",get:function get(){return _objectSpread(_objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFields),"properties",this)),{},{/**
   ...
   */},{key:"tag",get:function get(){return"simple-fields"}}]);function SimpleFields(){var _this;babelHelpers.classCallCheck(this,SimpleFields);_this=_super.call(this);_this.activeTabs={};_this.addEventListener("active-tab-changed",_this._handleActiveTab);setTimeout(function(){new Promise(function(res,rej){return _require.default(["./lib/simple-fields-field.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./lib/simple-fields-tabs.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./lib/simple-fields-code.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./lib/simple-fields-upload.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../simple-picker/simple-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../simple-colors/lib/simple-colors-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../simple-icon-picker/simple-icon-picker.js"],res,rej)})},0);return _this}/**
