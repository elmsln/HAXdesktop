define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/polymer/lib/legacy/templatizer-behavior.js","../../@polymer/polymer/lib/legacy/mutable-data-behavior.js","../../@polymer/polymer/lib/legacy/class.js"],function(_exports,_polymerElement,_renderStatus,_polymerDom,_templatizerBehavior,_mutableDataBehavior,_class){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.GrafittoFilter=void 0;function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(Object(source),!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function _templateObject_a1a0e500afe111eab5c3b1e04e313b03(){var data=babelHelpers.taggedTemplateLiteral(["\n      <div id=\"dom\"><slot></slot></div>\n    "]);_templateObject_a1a0e500afe111eab5c3b1e04e313b03=function _templateObject_a1a0e500afe111eab5c3b1e04e313b03(){return data};return data}function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=babelHelpers.getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget)}else{result=Super.apply(this,arguments)}return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"===typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"===typeof Proxy)return!0;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return!0}catch(e){return!1}}/**
@license
...
*/var GrafittoFilter=/*#__PURE__*/function(_mixinBehaviors){babelHelpers.inherits(GrafittoFilter,_mixinBehaviors);var _super=_createSuper(GrafittoFilter);function GrafittoFilter(){babelHelpers.classCallCheck(this,GrafittoFilter);return _super.apply(this,arguments)}babelHelpers.createClass(GrafittoFilter,[{key:"filter",/**
   * Filters the items using the f function provided. Recommended when f function is provided
   */value:function filter(){//This forces _computeFiltered function to do its job :-)
this.where=""}/**
   ...
   */},{key:"_computeFiltered",value:function _computeFiltered(items,where,like,caseSensitive){var regex=null;if(caseSensitive){regex=new RegExp(like)}else{regex=new RegExp(like,"i")}var filtered=[];if(this.f){var customFunction=this.f.bind(this);filtered=items.filter(customFunction)}else{//Save a reference to this object
...
if("number"==typeof item){return regex.test(item.toString())}})}return filtered}/**
   ...
   */},{key:"_populateUserTemplate",value:function _populateUserTemplate(filtered){// set after template is stamped
...
this.appendChild(this.__clone.root)}/**
   ...
   */},{key:"_decomposeWhere",value:function _decomposeWhere(where,item){return where.split(".").reduce(function(a,b){return a&&a[b]},item)}/**
   * The `filter` event is fired whenever filtering is done before populating the dom.
   *
   * @event filter
   */},{key:"_onFilter",value:function _onFilter(){this.dispatchEvent(new CustomEvent("filter",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}))}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_a1a0e500afe111eab5c3b1e04e313b03())}},{key:"tag",get:function get(){return"grafitto-filter"}},{key:"properties",get:function get(){return _objectSpread(_objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(GrafittoFilter),"properties",this)),{},{/**
       ...
       * Filtered items
       */filtered:{type:Array,computed:"_computeFiltered(items, where, like, caseSensitive)",observer:"_onFilter",notify:!0},/**
       * Custom filter function, if this is provided then 'where' and 'like' are ignored
       */f:{type:Function,notify:!0}})}},{key:"observers",get:function get(){return["_populateUserTemplate(filtered)"]}}]);return GrafittoFilter}((0,_class.mixinBehaviors)([_templatizerBehavior.Templatizer,_mutableDataBehavior.OptionalMutableDataBehavior],_polymerElement.PolymerElement));_exports.GrafittoFilter=GrafittoFilter;window.customElements.define(GrafittoFilter.tag,GrafittoFilter)});