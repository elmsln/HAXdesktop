...
get:function get(){var styles=(0,_litElement.css)("");if(babelHelpers.get(babelHelpers.getPrototypeOf(_class),"styles",this)){styles=babelHelpers.get(babelHelpers.getPrototypeOf(_class),"styles",this)}return[styles,(0,_litElement.css)(_templateObject2_d6b7ced0812711eb9b3b3bc8a337bd59())]}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(_class),"properties",this),{/**
         ...
         */dark:{name:"dark",type:Boolean,reflect:!0}})}}]);function _class(){var _this;babelHelpers.classCallCheck(this,_class);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(_class).call(this));_this.accentColor="grey";_this.dark=!1;_this.colors=_simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.colors;return _this}babelHelpers.createClass(_class,[{key:"invertShade",/**
     * gets the current shade
     *
     * @param {string} the shade
     * @param {number} the inverted shade
     */value:function invertShade(shade){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.invertShade(shade)}/**
     ...
     */},{key:"getColorInfo",value:function getColorInfo(colorName){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getColorInfo(colorName)}/**
     ...
     */},{key:"makeVariable",value:function makeVariable(){var color=0<arguments.length&&arguments[0]!==void 0?arguments[0]:"grey",shade=1<arguments.length&&arguments[1]!==void 0?arguments[1]:1,theme=2<arguments.length&&arguments[2]!==void 0?arguments[2]:"default";return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.makeVariable(color="grey",shade=1,theme="default")}/**
     ...
     */},{key:"getContrastingColors",value:function getContrastingColors(colorName,colorShade,isLarge){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getContrastingColors(colorName,colorShade,isLarge)}/**
     * for large or small text given a color and its shade,
     ...
     */},{key:"getContrastingShades",value:function getContrastingShades(isLarge,colorName,colorShade,contrastName){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getContrastingShades(isLarge,colorName,colorShade,contrastName)}/**
     ...
     */},{key:"isContrastCompliant",value:function isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}],[{key:"tag",get:function get(){return"simple-colors"}}]);return _class}(SuperClass))};/**
 * `simple-colors`
 ...
 */_exports.SimpleColorsSuper=SimpleColorsSuper;var SimpleColors=/*#__PURE__*/function(_SimpleColorsSuper){babelHelpers.inherits(SimpleColors,_SimpleColorsSuper);function SimpleColors(){babelHelpers.classCallCheck(this,SimpleColors);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleColors).apply(this,arguments))}return SimpleColors}(SimpleColorsSuper(_litElement.LitElement));_exports.SimpleColors=SimpleColors;window.customElements.define(SimpleColors.tag,SimpleColors)});