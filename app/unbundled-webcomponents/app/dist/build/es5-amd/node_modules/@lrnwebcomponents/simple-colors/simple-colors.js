...
get:function get(){return[(0,_litElement.css)(_templateObject2_a473db20afe111eab5c3b1e04e313b03())]}},{key:"properties",get:function get(){return _objectSpread(_objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(_class),"properties",this)),{},{/**
         ...
         * make the default theme dark?
         */colors:{name:"colors",type:Object}})}}]);function _class(){var _this;babelHelpers.classCallCheck(this,_class);_this=_super.call(this);_this.accentColor="grey";_this.dark=!1;_this.__utils=window.SimpleColorsSharedStyles.requestAvailability();_this.colors=window.SimpleColorsSharedStyles.colors;return _this}babelHelpers.createClass(_class,[{key:"invertShade",/**
     * gets the current shade
     *
     * @param {string} the shade
     * @param {number} the inverted shade
     */value:function invertShade(shade){return this.__utils.invertShade(shade)}/**
     ...
     */},{key:"isContrastCompliant",value:function isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return this.__utils.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}],[{key:"tag",get:function get(){return"simple-colors"}}]);return _class}(SuperClass)};/**
 * `simple-colors`
 ...
 */_exports.SimpleColorsSuper=SimpleColorsSuper;var SimpleColors=/*#__PURE__*/function(_SimpleColorsSuper){babelHelpers.inherits(SimpleColors,_SimpleColorsSuper);var _super2=_createSuper(SimpleColors);function SimpleColors(){babelHelpers.classCallCheck(this,SimpleColors);return _super2.apply(this,arguments)}return SimpleColors}(SimpleColorsSuper(_litElement.LitElement));_exports.SimpleColors=SimpleColors;window.customElements.define(SimpleColors.tag,SimpleColors)});