define(["exports","../../lit-element/lit-element.js","../../@polymer/paper-icon-button/paper-icon-button.js","../../@polymer/iron-icons/iron-icons.js","../simple-tooltip/simple-tooltip.js"],function(_exports,_litElement,_paperIconButton,_ironIcons,_simpleTooltip){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.A11yCollapse=void 0;function _templateObject4_a0d3a9f0afe111eab5c3b1e04e313b03(){var data=babelHelpers.taggedTemplateLiteral(["\n      <div id=\"heading\">\n        <div id=\"text\"><slot name=\"heading\"></slot></div>\n        <paper-icon-button\n          id=\"expand\"\n          class=\"","\"\n          @click=\"","\"\n          ?disabled=\"","\"\n          .label=\"","\"\n          .icon=\"","\"\n          aria-controls=\"content\"\n          aria-expanded=\"","\"\n        >\n        </paper-icon-button>\n        <simple-tooltip for=\"expand\"\n          >","</simple-tooltip\n        >\n      </div>\n    "]);_templateObject4_a0d3a9f0afe111eab5c3b1e04e313b03=function _templateObject4_a0d3a9f0afe111eab5c3b1e04e313b03(){return data};return data}function _templateObject3_a0d3a9f0afe111eab5c3b1e04e313b03(){var data=babelHelpers.taggedTemplateLiteral(["\n      <div\n        id=\"heading\"\n        aria-controls=\"content\"\n        aria-expanded=\"","\"\n        role=\"button\"\n        @click=\"","\"\n        ?disabled=\"","\"\n        .label=\"","\"\n      >\n        <div id=\"text\"><slot name=\"heading\"></slot></div>\n        <iron-icon\n          id=\"expand\"\n          class=\"","\"\n          .icon=\"","\"\n          aria-hidden=\"true\"\n        >\n        </iron-icon>\n      </div>\n      <simple-tooltip for=\"heading\"\n        >","</simple-tooltip\n      >\n    "]);_templateObject3_a0d3a9f0afe111eab5c3b1e04e313b03=function _templateObject3_a0d3a9f0afe111eab5c3b1e04e313b03(){return data};return data}function _templateObject2_a0d3a9f0afe111eab5c3b1e04e313b03(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          margin: var(--a11y-collapse-margin, 15px 0);\n          border: var(--a11y-collapse-border, 1px solid);\n          border-color: var(--a11y-collapse-border-color, inherit);\n          transition: all 0.5s cubic-bezier(0.075, 0.82, 0.165, 1);\n        }\n        :host(:not(:first-of-type)) {\n          border-top: var(\n            --a11y-collapse-border-between,\n            var(--a11y-collapse-border, 1px solid)\n          );\n        }\n        :host([disabled]) {\n          opacity: 0.5;\n        }\n        *[aria-controls=\"content\"][disabled] {\n          cursor: not-allowed;\n        }\n        #heading {\n          display: flex;\n          justify-content: stretch;\n          align-items: center;\n          padding: 0\n            var(\n              --a11y-collapse-padding-right,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            )\n            0\n            var(\n              --a11y-collapse-padding-left,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            );\n          font-weight: var(--a11y-collapse-heading-font-weight, bold);\n          margin: var(--a11y-collapse-margin, unset);\n          color: var(--a11y-collapse-heading-color, unset);\n          background-color: var(\n            --a11y-collapse-heading-background-color,\n            unset\n          );\n        }\n        :host([disabled]) #heading {\n          color: var(--a11y-collapse-disabled-heading-color, unset);\n          background-color: var(\n            --a11y-collapse-heading-disabled-background-color,\n            unset\n          );\n        }\n        #text {\n          flex-grow: 1;\n          overflow: hidden;\n        }\n        #expand {\n          transform: rotate(0deg);\n          transition: transform 0.75s ease;\n          padding: (--a11y-collapse-icon-padding, unset);\n        }\n        #expand.rotated {\n          transform: rotate(-90deg);\n          transition: transform 0.75s ease;\n        }\n        #content {\n          padding: 0\n            var(\n              --a11y-collapse-padding-right,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            )\n            0\n            var(\n              --a11y-collapse-padding-left,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            );\n          border-top: 0px solid;\n          border-color: var(--a11y-collapse-border-color, inherit);\n          max-height: 0;\n          transition: all 0.75s ease;\n          overflow-y: hidden;\n        }\n        :host #content-inner {\n          max-height: 0;\n          overflow-y: var(--a11y-collapse-overflow-y, hidden);\n        }\n        :host([expanded]) #content {\n          padding: var(\n              --a11y-collapse-padding-top,\n              var(--a11y-collapse-vertical-padding, 16px)\n            )\n            var(\n              --a11y-collapse-padding-right,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            )\n            var(\n              --a11y-collapse-padding-bottom,\n              var(--a11y-collapse-vertical-padding, 16px)\n            )\n            var(\n              --a11y-collapse-padding-left,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            );\n          border-top: var(--a11y-collapse-border, 1px solid);\n          border-color: var(--a11y-collapse-border-color, inherit);\n          max-height: 200000000000vh;\n        }\n        :host([expanded]) #content-inner {\n          max-height: var(--a11y-collapse-max-height, 200000000000vh);\n          transition: max-height 0.75s ease;\n        }\n      "]);_templateObject2_a0d3a9f0afe111eab5c3b1e04e313b03=function _templateObject2_a0d3a9f0afe111eab5c3b1e04e313b03(){return data};return data}function _templateObject_a0d3a9f0afe111eab5c3b1e04e313b03(){var data=babelHelpers.taggedTemplateLiteral(["\n      ","\n      <div\n        id=\"content\"\n        aria-hidden=\"","\"\n        aria-labelledby=\"heading\"\n        aria-live=\"polite\"\n      >\n        <div id=\"content-inner\">\n          <slot name=\"content\"></slot>\n          <slot></slot>\n        </div>\n      </div>\n    "]);_templateObject_a0d3a9f0afe111eab5c3b1e04e313b03=function _templateObject_a0d3a9f0afe111eab5c3b1e04e313b03(){return data};return data}function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=babelHelpers.getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget)}else{result=Super.apply(this,arguments)}return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"===typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"===typeof Proxy)return!0;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return!0}catch(e){return!1}}/**
 * `a11y-collapse`
 ...
 * @element a11y-collapse
 */var A11yCollapse=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(A11yCollapse,_LitElement);var _super=_createSuper(A11yCollapse);babelHelpers.createClass(A11yCollapse,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject_a0d3a9f0afe111eab5c3b1e04e313b03(),this.headingButton||this.accordion?this._makeHeadingButton():this._makeIconButton(),this.expanded?"false":"true")}}],[{key:"styles",get:function get(){return[(0,_litElement.css)(_templateObject2_a0d3a9f0afe111eab5c3b1e04e313b03())]}},{key:"tag",get:function get(){return"a11y-collapse"}},{key:"properties",get:function get(){return{/**
