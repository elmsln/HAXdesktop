define(["exports","../../lit-element/lit-element.js","../simple-icon/lib/simple-icon-button-lite.js","../simple-icon/lib/simple-icon-lite.js","../simple-icon/lib/simple-icons.js","../simple-tooltip/simple-tooltip.js"],function(_exports,_litElement,_simpleIconButtonLite,_simpleIconLite,_simpleIcons,_simpleTooltip){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.A11yCollapse=void 0;function _templateObject4_05aedf30812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral(["\n      <div id=\"heading\">\n        <div id=\"text\"><slot name=\"heading\"></slot></div>\n        <simple-icon-button-lite\n          id=\"expand\"\n          class=\"","\"\n          @click=\"","\"\n          ?disabled=\"","\"\n          .label=\"","\"\n          .icon=\"","\"\n          aria-controls=\"content\"\n          aria-expanded=\"","\"\n        >\n        </simple-icon-button-lite>\n        <simple-tooltip for=\"expand\"\n          >","</simple-tooltip\n        >\n      </div>\n    "]);_templateObject4_05aedf30812d11eb9c332bb120816628=function _templateObject4_05aedf30812d11eb9c332bb120816628(){return data};return data}function _templateObject3_05aedf30812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral(["\n      <div\n        id=\"heading\"\n        aria-controls=\"content\"\n        aria-expanded=\"","\"\n        role=\"button\"\n        @click=\"","\"\n        ?disabled=\"","\"\n        .label=\"","\"\n      >\n        <div id=\"text\"><slot name=\"heading\"></slot></div>\n        <simple-icon-lite\n          id=\"expand\"\n          class=\"","\"\n          .icon=\"","\"\n          aria-hidden=\"true\"\n        >\n        </simple-icon-lite>\n      </div>\n      <simple-tooltip for=\"heading\"\n        >","</simple-tooltip\n      >\n    "]);_templateObject3_05aedf30812d11eb9c332bb120816628=function _templateObject3_05aedf30812d11eb9c332bb120816628(){return data};return data}function _templateObject2_05aedf30812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          margin: var(--a11y-collapse-margin, 15px 0);\n          border: var(--a11y-collapse-border, 1px solid);\n          border-color: var(--a11y-collapse-border-color, inherit);\n          transition: all 0.5s cubic-bezier(0.075, 0.82, 0.165, 1);\n        }\n        :host(:not(:first-of-type)) {\n          border-top: var(\n            --a11y-collapse-border-between,\n            var(--a11y-collapse-border, 1px solid)\n          );\n        }\n        :host([disabled]) {\n          opacity: 0.5;\n        }\n        *[aria-controls=\"content\"][disabled] {\n          cursor: not-allowed;\n        }\n        #heading {\n          display: flex;\n          justify-content: stretch;\n          align-items: center;\n          padding: 0\n            var(\n              --a11y-collapse-padding-right,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            )\n            0\n            var(\n              --a11y-collapse-padding-left,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            );\n          font-weight: var(--a11y-collapse-heading-font-weight, bold);\n          margin: var(--a11y-collapse-margin, unset);\n          color: var(--a11y-collapse-heading-color, unset);\n          background-color: var(\n            --a11y-collapse-heading-background-color,\n            unset\n          );\n        }\n        :host([disabled]) #heading {\n          color: var(--a11y-collapse-disabled-heading-color, unset);\n          background-color: var(\n            --a11y-collapse-heading-disabled-background-color,\n            unset\n          );\n        }\n        #text {\n          flex-grow: 1;\n          overflow: hidden;\n        }\n        #expand {\n          transform: rotate(0deg);\n          transition: transform 0.75s ease;\n          padding: (--a11y-collapse-icon-padding, unset);\n        }\n        #expand.rotated {\n          transform: rotate(-90deg);\n          transition: transform 0.75s ease;\n        }\n        #content {\n          padding: 0\n            var(\n              --a11y-collapse-padding-right,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            )\n            0\n            var(\n              --a11y-collapse-padding-left,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            );\n          border-top: 0px solid;\n          border-color: var(--a11y-collapse-border-color, inherit);\n          max-height: 0;\n          transition: all 0.75s ease;\n          overflow-y: hidden;\n        }\n        :host #content-inner {\n          max-height: 0;\n          overflow-y: var(--a11y-collapse-overflow-y, hidden);\n        }\n        :host([expanded]) #content {\n          padding: var(\n              --a11y-collapse-padding-top,\n              var(--a11y-collapse-vertical-padding, 16px)\n            )\n            var(\n              --a11y-collapse-padding-right,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            )\n            var(\n              --a11y-collapse-padding-bottom,\n              var(--a11y-collapse-vertical-padding, 16px)\n            )\n            var(\n              --a11y-collapse-padding-left,\n              var(--a11y-collapse-horizontal-padding, 16px)\n            );\n          border-top: var(--a11y-collapse-border, 1px solid);\n          border-color: var(--a11y-collapse-border-color, inherit);\n          max-height: 200000000000vh;\n        }\n        :host([expanded]) #content-inner {\n          max-height: var(--a11y-collapse-max-height, 200000000000vh);\n          transition: max-height 0.75s ease;\n        }\n      "]);_templateObject2_05aedf30812d11eb9c332bb120816628=function _templateObject2_05aedf30812d11eb9c332bb120816628(){return data};return data}function _templateObject_05aedf30812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral(["\n      ","\n      <div\n        id=\"content\"\n        aria-hidden=\"","\"\n        aria-labelledby=\"heading\"\n        aria-live=\"polite\"\n      >\n        <div id=\"content-inner\">\n          <slot name=\"content\"></slot>\n          <slot></slot>\n        </div>\n      </div>\n    "]);_templateObject_05aedf30812d11eb9c332bb120816628=function _templateObject_05aedf30812d11eb9c332bb120816628(){return data};return data}/**
 * `a11y-collapse`
 ...
 */var A11yCollapse=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(A11yCollapse,_LitElement);babelHelpers.createClass(A11yCollapse,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject_05aedf30812d11eb9c332bb120816628(),this.headingButton||this.accordion?this._makeHeadingButton():this._makeIconButton(),this.expanded?"false":"true")}}],[{key:"styles",get:function get(){return[(0,_litElement.css)(_templateObject2_05aedf30812d11eb9c332bb120816628())]}},{key:"tag",get:function get(){return"a11y-collapse"}},{key:"properties",get:function get(){return{/**
       * Heading is the expand button.
       */headingButton:{type:Boolean,reflect:!0,attribute:"heading-button"},/**
       * disbled
       ...
       */icon:{type:String},/**
       * icon when expanded
       */iconExpanded:{type:String,attribute:"icon-expanded"},/**
       * label for the button
       */label:{type:String},/**
       * optional label for the button when expanded
       */labelExpanded:{type:String,attribute:"label-expanded"},/**
       * tooltip for the button
       */tooltip:{type:String},/**
       * optional tooltip for the button when expanded
       */tooltipExpanded:{type:String,attribute:"tooltip-expanded"},/**
       * @deprecated Use {@link headingButton} instead
       */accordion:{type:Boolean,reflect:!0,attribute:"accordion"}}}}]);function A11yCollapse(){var _this;babelHelpers.classCallCheck(this,A11yCollapse);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yCollapse).call(this));_this.headingButton=!1;_this.accordion=!1;_this.disabled=!1;_this.hidden=!1;_this.expanded=!1;_this.icon="icons:expand-more";_this.label="expand / collapse";_this.tooltip="toggle expand / collapse";return _this}babelHelpers.createClass(A11yCollapse,[{key:"connectedCallback",value:function connectedCallback(){var _this2=this;babelHelpers.get(babelHelpers.getPrototypeOf(A11yCollapse.prototype),"connectedCallback",this).call(this);setTimeout(function(){/**
       * Fires when constructed, so that parent radio group can listen for it.
       *
       * @event a11y-collapse-attached
       */_this2.dispatchEvent(new CustomEvent("a11y-collapse-attached",{bubbles:!0,cancelable:!0,composed:!0,detail:_this2}))},0)}/**
   ...
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){/**
     ...
     */this.dispatchEvent(new CustomEvent("a11y-collapse-detached",{bubbles:!0,cancelable:!0,composed:!0,detail:this}));babelHelpers.get(babelHelpers.getPrototypeOf(A11yCollapse.prototype),"disconnectedCallback",this).call(this)}/**
   * Collapses the content
   */},{key:"collapse",value:function collapse(){this.toggle(!1)}/**
   * Expands the content
   */},{key:"expand",value:function expand(){this.toggle(!0)}/**
   * Toggles based on mode
   * @param {boolean} open whether to toggle open
   */},{key:"toggle",value:function toggle(){var open=0<arguments.length&&arguments[0]!==void 0?arguments[0]:!this.expanded;this.expanded=open}},{key:"updated",value:function updated(changedProperties){var _this3=this;changedProperties.forEach(function(oldValue,propName){if("expanded"===propName)_this3._fireToggleEvents()})}/**
   * Fires toggling events
   */},{key:"_fireToggleEvents",value:function _fireToggleEvents(){/**
     * Fires when toggled.
     *
     * @event toggle
     */this.dispatchEvent(new CustomEvent("toggle",{bubbles:!0,cancelable:!0,composed:!0,detail:this}));/**
     * Fires when toggled. @deprecated Use `toggle` instead
     *
     * @event a11y-collapse-toggle
     */this.dispatchEvent(new CustomEvent("a11y-collapse-toggle",{bubbles:!0,cancelable:!0,composed:!0,detail:this}));if(this.expanded){/**
       * Fires when expanded.
       *
       * @event expand
       */this.dispatchEvent(new CustomEvent("expand",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}else{/**
       * Fires when collapsed.
       *
       * @event collapse
       */this.dispatchEvent(new CustomEvent("collapse",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}/**
   ...
   */},{key:"_getExpanded",value:function _getExpanded(defaultProp,expandedProp,expanded){return expanded&&expandedProp?expandedProp:defaultProp}/**
