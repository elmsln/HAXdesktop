define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.Hexagon=void 0;/**
 ...
 */var Hexagon=/*#__PURE__*/function(_HTMLElement){babelHelpers.inherits(Hexagon,_HTMLElement);babelHelpers.createClass(Hexagon,[{key:"html",// render function
get:function get(){return"\n<style>\n:host {\n  display: inline-flex;\n  position: relative;\n  height: 36px;\n  width: 36px;\n}\n\n:host div,\n:host div:before,\n:host div:after {\n background-color: var(--hexagon-color, orange);\n}\n\ndiv {\n  width: var(--hexagon-width, 30px);\n  height: var(--hexagon-height, 18px);\n  margin: 9px 3px;\n  position: absolute;\n  color: var(--hexagon-color, orange);\n}\ndiv:before, div:after {\n  content: '';\n  position: absolute;\n  width: var(--hexagon-width, 30px);\n  height: var(--hexagon-height, 18px);\n}\ndiv:before {\n  -webkit-transform: rotate(60deg);\n          transform: rotate(60deg);\n}\ndiv:after {\n  -webkit-transform: rotate(-60deg);\n          transform: rotate(-60deg);\n}\n</style>\n    <div></div>"}/**
   ...
   */}],[{key:"tag",get:function get(){return"hex-a-gon"}/**
   * life cycle
   */}]);function Hexagon(){var _this,delayRender=0<arguments.length&&arguments[0]!==void 0?arguments[0]:!1;babelHelpers.classCallCheck(this,Hexagon);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(Hexagon).call(this));// set tag for later use
