 ...
 */var AccentCard=/*#__PURE__*/function(_IntersectionObserver){babelHelpers.inherits(AccentCard,_IntersectionObserver);babelHelpers.createClass(AccentCard,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject_0611e6c0812d11eb9c332bb120816628(),!this.elementVisible||!this.imageSrc,this.elementVisible&&this.imageSrc?"background-image: url(".concat(this.imageSrc,");"):"")}// haxProperty definition
}],[{key:"tag",/**
   * Store tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */get:function get(){return"accent-card"}// render function
},{key:"styles",get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(AccentCard),"styles",this)),[(0,_litElement.css)(_templateObject2_0611e6c0812d11eb9c332bb120816628())])}},{key:"haxProperties",get:function get(){var _ref;return _ref={canEditSource:!0,canPosition:!1},babelHelpers.defineProperty(_ref,"canEditSource",!0),babelHelpers.defineProperty(_ref,"gizmo",{title:"Accent Card",description:"A card with optional accent styling.",icon:"chrome-reader-mode",color:"light-blue",groups:["Media","Content","Image","Presentation"],handles:[{type:"media",url:"source"},{type:"image",source:"imageSrc"},{type:"text",url:"source"}],meta:{author:"nikkimk",owner:"The Pennsylvania State University"}}),babelHelpers.defineProperty(_ref,"settings",{configure:[{slot:"heading",title:"Heading",description:"A heading for card.",inputMethod:"textfield"},{slot:"subheading",title:"Subheading",description:"An optional subheading for card.",inputMethod:"textfield"},{slot:"content",title:"Content",description:"Content for card.",inputMethod:"textfield"},{slot:"footer",title:"Footer",description:"An optional footer for card.",inputMethod:"textfield"},{property:"imageSrc",title:"Image",description:"Optional image",inputMethod:"haxupload",icon:"editor:insert-photo"},{property:"imageAlign",title:"imageAlign",description:"Image Horizontal Alignment",inputMethod:"select",options:{left:"left",center:"center",right:"right"}},{property:"imageValign",title:"imageValign",description:"Image Vertical Alignment",inputMethod:"select",options:{top:"top",center:"center",bottom:"bottom"}},{property:"accentColor",title:"Accent Color",description:"An optional accent color.",inputMethod:"colorpicker",icon:"editor:format-color-fill"},{property:"dark",title:"Dark Theme",description:"Enable Dark Theme",inputMethod:"boolean",icon:"icons:invert-colors"},{property:"horizontal",title:"Horizontal",description:"Horizontal orientation?",inputMethod:"boolean"},{property:"accentHeading",title:"Heading Accent",description:"Apply accent color to heading?",inputMethod:"boolean"},{property:"accentBackground",title:"Background Accent",description:"Apply accent color to card background?",inputMethod:"boolean"},{property:"noBorder",title:"No Border Accent",description:"Remove border accent?",inputMethod:"boolean"},{property:"flat",title:"Flat",description:"Remove box shadow?",inputMethod:"boolean"}],advanced:[]}),babelHelpers.defineProperty(_ref,"demoSchema",[{tag:"accent-card",properties:{style:"maxWidth:600px;width:100%;",accentColor:"cyan",dark:!0,imageSrc:"http://placekitten.com/200/600"},content:"<span slot=\"heading\">Card Heading</span>\n<p slot=\"content\">This is the body of the card.</p>"}]),babelHelpers.defineProperty(_ref,"saveOptions",{unsetAttributes:["colors","element-visible"]}),_ref}}]);function AccentCard(){var _this;babelHelpers.classCallCheck(this,AccentCard);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(AccentCard).call(this));_this.accentBackground=!1;_this.accentHeading=!1;_this.flat=!1;_this.horizontal=!1;_this.imageAlign=null;_this.imageSrc=null;_this.imageValign=null;_this.noBorder=!1;return _this}// properties available to custom element for data binding
babelHelpers.createClass(AccentCard,null,[{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(AccentCard),"properties",this),{/**
       * Apply accent color to card background
       */accentBackground:{type:Boolean,attribute:"accent-background",reflect:!0},/**
       * Apply accent color to heading
       */accentHeading:{type:Boolean,attribute:"accent-heading",reflect:!0},/**
       * Display card as flat (no box shadow);
       */flat:{type:Boolean,reflect:!0},/**
       * Display card as a horizontal layout? Default is vertical.
       */horizontal:{type:Boolean,reflect:!0},/**
       ...
       */imageAlign:{type:String,attribute:"image-align",reflect:!0},/**
       ...
       * - A null will allow temporary support to deprecated CSS variables
       */imageValign:{type:String,attribute:"image-valign",reflect:!0},/**
       * Removes think accent border
       */noBorder:{type:Boolean,attribute:"no-border",reflect:!0}})}}]);return AccentCard}((0,_IntersectionObserverMixin.IntersectionObserverMixin)(_simpleColors.SimpleColors));_exports.AccentCard=AccentCard;window.customElements.define(AccentCard.tag,AccentCard)});