define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HAXStax=_exports.HAXApp=void 0;/**
 `hax-app`
...
```
 * @element hax-stax
 */var HAXStax=/*#__PURE__*/function(_HAXApp){babelHelpers.inherits(HAXStax,_HAXApp);function HAXStax(){var _this2;babelHelpers.classCallCheck(this,HAXStax);_this2=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HAXStax).call(this));_this2.eventName="hax-register-stax";return _this2}babelHelpers.createClass(HAXStax,null,[{key:"tag",get:function get(){return"hax-stax"}}]);return HAXStax}(HAXApp);_exports.HAXStax=HAXStax;window.customElements.define(HAXStax.tag,HAXStax)});