define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HAXStax=_exports.HAXBlox=_exports.HAXApp=void 0;function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=babelHelpers.getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget)}else{result=Super.apply(this,arguments)}return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"===typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"===typeof Proxy)return!0;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return!0}catch(e){return!1}}/**
 `hax-app`
...
```
 * @element hax-app
 */var HAXApp=/*#__PURE__*/function(_HTMLElement){babelHelpers.inherits(HAXApp,_HTMLElement);var _super=_createSuper(HAXApp);function HAXApp(){var _this;babelHelpers.classCallCheck(this,HAXApp);_this=_super.call(this);_this.eventName="hax-register-app";return _this}babelHelpers.createClass(HAXApp,[{key:"connectedCallback",/**
   * Connected life cycle
   */value:function connectedCallback(){if(babelHelpers.typeof(this.data)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){// account for possibly needing to convert string to data object
if("string"===typeof this.data){this.data=JSON.parse(this.data)}this.dispatchEvent(new CustomEvent(this.eventName,{bubbles:!0,composed:!0,cancelable:!1,detail:this.data}))}}}],[{key:"tag",get:function get(){return"hax-app"}}]);return HAXApp}(/*#__PURE__*/babelHelpers.wrapNativeSuper(HTMLElement));_exports.HAXApp=HAXApp;window.customElements.define(HAXApp.tag,HAXApp);/**
 `hax-blox`
...
```
 * @element hax-blox
 */var HAXBlox=/*#__PURE__*/function(_HAXApp){babelHelpers.inherits(HAXBlox,_HAXApp);var _super2=_createSuper(HAXBlox);function HAXBlox(){var _this2;babelHelpers.classCallCheck(this,HAXBlox);_this2=_super2.call(this);_this2.eventName="hax-register-blox";return _this2}babelHelpers.createClass(HAXBlox,null,[{key:"tag",get:function get(){return"hax-blox"}}]);return HAXBlox}(HAXApp);_exports.HAXBlox=HAXBlox;window.customElements.define(HAXBlox.tag,HAXBlox);/**
 `hax-stax`
...
```
 * @element hax-stax
 */var HAXStax=/*#__PURE__*/function(_HAXApp2){babelHelpers.inherits(HAXStax,_HAXApp2);var _super3=_createSuper(HAXStax);function HAXStax(){var _this3;babelHelpers.classCallCheck(this,HAXStax);_this3=_super3.call(this);_this3.eventName="hax-register-stax";return _this3}babelHelpers.createClass(HAXStax,null,[{key:"tag",get:function get(){return"hax-stax"}}]);return HAXStax}(HAXApp);_exports.HAXStax=HAXStax;window.customElements.define(HAXStax.tag,HAXStax)});