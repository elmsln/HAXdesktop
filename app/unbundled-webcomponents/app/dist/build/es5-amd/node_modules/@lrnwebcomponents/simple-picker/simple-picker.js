 ...
 */var SimplePicker=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(SimplePicker,_LitElement);var _super=_createSuper(SimplePicker);babelHelpers.createClass(SimplePicker,[{key:"render",// render function
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_a5346c00afe111eab5c3b1e04e313b03(),!this.label||""===this.label.trim(),this.label&&""!==this.label.trim()?this.label.trim():"",this.__activeDesc,this.ariaLabelledby,this.disabled,this._handleListboxClick,this._handleListboxMousedown,this._handleListboxKeydown,this.hideOptionLabels,this.titleAsHtml,this.__selectedOption?this.__selectedOption.icon:!1,this.__selectedOption?this.__selectedOption.alt:!1,this.__selectedOption?this.__selectedOption.style:!1,this.__options?this.__options.map(function(row,rownum){return(0,_litElement.html)(_templateObject2_a5346c00afe111eab5c3b1e04e313b03(),Array.isArray(row)?row.map(function(option,colnum){return(0,_litElement.html)(_templateObject3_a5346c00afe111eab5c3b1e04e313b03(),_this2._handleOptionFocus,_this2._handleSetSelectedOption,"".concat(_this2.__activeDesc)==="option-".concat(rownum,"-").concat(colnum),_this2.hideOptionLabels,!_this2.allowNull&&!option.value,_this2.value===option.value,_this2.titleAsHtml,_this2.data,option.icon,rownum,colnum,option.alt,option.style,_this2.value===option.value?"true":"false",option.value)}):"")}):"")}// properties available to the custom element for data binding
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject4_a5346c00afe111eab5c3b1e04e313b03())]}},{key:"properties",get:function get(){return _objectSpread(_objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(SimplePicker),"properties",this)),{},{/**
       * llow a null value?
