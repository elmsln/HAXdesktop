...
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_0819c4b0812d11eb9c332bb120816628(),!this.label||""===this.label.trim(),this.label&&""!==this.label.trim()?this.label.trim():"",this.__activeDesc,this.ariaLabelledby,this.disabled,this._handleListboxClick,this._handleListboxMousedown,this._handleListboxKeydown,this.hideOptionLabels,this.titleAsHtml,this.__selectedOption?this.__selectedOption.icon:!1,this.__selectedOption?this.__selectedOption.alt:!1,this.__selectedOption?this.__selectedOption.style:!1,this.__options?this.__options.map(function(row,rownum){return(0,_litElement.html)(_templateObject2_0819c4b0812d11eb9c332bb120816628(),Array.isArray(row)?row.map(function(option,colnum){return(0,_litElement.html)(_templateObject3_0819c4b0812d11eb9c332bb120816628(),_this2._handleOptionFocus,_this2._handleSetSelectedOption,"".concat(_this2.__activeDesc)==="option-".concat(rownum,"-").concat(colnum),_this2.hideOptionLabels,!_this2.allowNull&&!option.value,_this2.value===option.value,_this2.titleAsHtml,_this2.data,option.icon,rownum,colnum,option.alt,option.style,_this2.value===option.value?"true":"false",option.value)}):"")}):"")}// properties available to the custom element for data binding
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject4_0819c4b0812d11eb9c332bb120816628())]}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(SimplePicker),"properties",this),{/**
       * llow a null value?
...
}]);function SimplePicker(){var _this;babelHelpers.classCallCheck(this,SimplePicker);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimplePicker).call(this));new Promise(function(res,rej){return _require.default(["./lib/simple-picker-option.js"],res,rej)});_this.tag=SimplePicker.tag;_this.allowNull=!1;_this.alignRight=!1;_this.ariaLabelledby=null;_this.blockLabel=!1;_this.disabled=!1;_this.expanded=!1;_this.hideOptionLabels=!1;_this.hideSample=!1;_this.label=null;_this.__options=[[]];_this.options=[[{icon:null,style:null,alt:null,value:null}]];_this.titleAsHtml=!1;_this.value=null;_this.__activeDesc="option-0-0";_this.__hasLabel=!0;_this.__selectedOption={};_this.addEventListener("blur",function(e){this.expanded=!1});// map our imported properties json to real props on the element
// @notice static getter of properties is built via tooling
// to edit modify src/test-lit-properties.json
var obj=SimplePicker.properties;for(var p in obj){if(obj.hasOwnProperty(p)){if(_this.hasAttribute(p)){_this[p]=_this.getAttribute(p)}else{if(p.reflect)_this.setAttribute(p,obj[p].value);_this[p]=obj[p].value}}}return _this}babelHelpers.createClass(SimplePicker,[{key:"updated",value:function updated(changedProperties){var _this3=this;changedProperties.forEach(function(oldValue,propName){if("value"===propName)_this3._valueChanged();if("options"===propName)_this3._optionsChanged()});/**
   ...
   * @returns {void}
   */},{key:"_goToOption",value:function _goToOption(rownum,colnum){var targetId=(0,_litElement.html)(_templateObject5_0819c4b0812d11eb9c332bb120816628(),rownum,colnum),target=this.shadowRoot.querySelector("#"+targetId),active=this.shadowRoot.querySelector("#"+this.__activeDesc);if(null!==target){target.tabindex=0;//allow item to be focusable.
...
this._goToOption(rownum+1,[0])}}}}/**
   ...
   * @returns {void}
   */},{key:"_valueChanged",value:function _valueChanged(){this._setSelectedOption();/**
