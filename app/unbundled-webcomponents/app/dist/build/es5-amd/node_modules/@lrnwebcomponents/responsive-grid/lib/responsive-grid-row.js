...
*/var ResponsiveGridRow=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(ResponsiveGridRow,_LitElement);var _super=_createSuper(ResponsiveGridRow);babelHelpers.createClass(ResponsiveGridRow,[{key:"render",/**
   * LitElement render
   */value:function render(){return(0,_litElement.html)(_templateObject_a7afa530afe111eab5c3b1e04e313b03(),this.xs,this.sm,this.md,this.lg,this.xl,this.responsiveToParent,this.screen,this.gutter)}/**
   * convention
   */}],[{key:"styles",/**
   * LitElement constructable styles enhancement
   */get:function get(){return[(0,_litElement.css)(_templateObject2_a7afa530afe111eab5c3b1e04e313b03())]}},{key:"tag",get:function get(){return"responsive-grid-row"}/**
   * HTMLElement
   */}]);function ResponsiveGridRow(){var _this;babelHelpers.classCallCheck(this,ResponsiveGridRow);_this=_super.call(this);_this.xl=null;_this.lg=null;_this.md=null;_this.sm=null;_this.xs=null;_this.gutter=0;_this.responsiveToParent=!1;_this.screen="xs";window.ResponsiveUtility.requestAvailability();return _this}/**
   * LitElement ready
   */babelHelpers.createClass(ResponsiveGridRow,[{key:"firstUpdated",value:function firstUpdated(){this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:this,attribute:"screen",relativeToParent:this.responsiveToParent}}))}/**
   * LitElement properties changed
   */},{key:"updated",value:function updated(changedProperties){var _this2=this;changedProperties.forEach(function(oldValue,propName){if("screen"==propName){// notify
_this2.dispatchEvent(new CustomEvent("screen-changed",{detail:{value:_this2[propName]}}))}})}}],[{key:"properties",get:function get(){return{/**
       ...
       */responsiveToParent:{type:Boolean,reflect:!0,attribute:"responsive-to-parent"},/*
       * screen size: xs, sm, md, lg, or xl
       */screen:{type:String,reflect:!0}}}}]);return ResponsiveGridRow}(_litElement.LitElement);_exports.ResponsiveGridRow=ResponsiveGridRow;window.customElements.define(ResponsiveGridRow.tag,ResponsiveGridRow)});