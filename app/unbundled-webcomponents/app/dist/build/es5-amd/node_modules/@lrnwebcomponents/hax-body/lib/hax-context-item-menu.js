define(["exports","../../../lit-element/lit-element.js","./hax-toolbar-menu.js","../../simple-tooltip/simple-tooltip.js"],function(_exports,_litElement,_haxToolbarMenu,_simpleTooltip){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxContextItemMenu=void 0;function _templateObject2_09557900812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-menu\n        id=\"menu\"\n        ?mini=\"","\"\n        ?disabled=\"","\"\n        ?action=\"","\"\n        .icon=\"","\"\n        .tooltip=\"","\"\n        .tooltip-direction=\"","\"\n        @selected-changed=\"","\"\n        .selected=\"","\"\n      >\n        <slot></slot>\n      </hax-toolbar-menu>\n    "]);_templateObject2_09557900812d11eb9c332bb120816628=function _templateObject2_09557900812d11eb9c332bb120816628(){return data};return data}function _templateObject_09557900812d11eb9c332bb120816628(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          box-sizing: border-box;\n        }\n        :host(mini) {\n          height: unset;\n          width: unset;\n        }\n      "]);_templateObject_09557900812d11eb9c332bb120816628=function _templateObject_09557900812d11eb9c332bb120816628(){return data};return data}/**
 ...
 */var HaxContextItemMenu=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(HaxContextItemMenu,_LitElement);babelHelpers.createClass(HaxContextItemMenu,null,[{key:"styles",/**
   ...
   */get:function get(){return[(0,_litElement.css)(_templateObject_09557900812d11eb9c332bb120816628())]}}]);function HaxContextItemMenu(){var _this;babelHelpers.classCallCheck(this,HaxContextItemMenu);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxContextItemMenu).call(this));_this._blockEvent=!1;_this.disabled=!1;_this.selectedValue=0;_this.action=!1;_this.direction="top";_this.icon="editor:text-fields";_this.label="";return _this}babelHelpers.createClass(HaxContextItemMenu,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject2_09557900812d11eb9c332bb120816628(),this.mini,this.disabled,this.action,this.icon,this.label,this.direction,this.selectedValueChanged,this.selectedValue)}},{key:"selectedValueChanged",value:function selectedValueChanged(e){this.selectedValue=e.detail}},{key:"updated",value:function updated(changedProperties){var _this2=this;changedProperties.forEach(function(oldValue,propName){if("selectedValue"==propName){// observer
...
for(var children=this.children,item={},j=0,i=0,len=children.length;i<len;i++){if("BUTTON"===children[i].tagName){if(j===newValue){item=children[i];len=i;continue}j++}}// ensure we have a value; if so, this becomes the event to look for
