...
*/ /**
 * @polymerMixin
 */var ProgressMixin=function ProgressMixin(superClass){return(/*#__PURE__*/function(_superClass){babelHelpers.inherits(VaadinProgressMixin,_superClass);function VaadinProgressMixin(){babelHelpers.classCallCheck(this,VaadinProgressMixin);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(VaadinProgressMixin).apply(this,arguments))}babelHelpers.createClass(VaadinProgressMixin,[{key:"ready",/** @protected */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(VaadinProgressMixin.prototype),"ready",this).call(this);this.setAttribute("role","progressbar")}/** @private */},{key:"_normalizedValueChanged",value:function _normalizedValueChanged(value,min,max){var newNormalizedValue=this._normalizeValue(value,min,max);this.style.setProperty("--vaadin-progress-value",newNormalizedValue);this.updateStyles({"--vaadin-progress-value":newNormalizedValue+""})}/** @private */},{key:"_valueChanged",value:function _valueChanged(newV,oldV){this.setAttribute("aria-valuenow",newV)}/** @private */},{key:"_minChanged",value:function _minChanged(newV,oldV){this.setAttribute("aria-valuemin",newV)}/** @private */},{key:"_maxChanged",value:function _maxChanged(newV,oldV){this.setAttribute("aria-valuemax",newV)}/**
