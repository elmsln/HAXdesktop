import{LitElement,html,css}from"../../../lit-element/lit-element.js";import{SimpleFieldsFieldset}from"./simple-fields-fieldset.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icons.js";import"./simple-fields-array-item.js";class SimpleFieldsArray extends SimpleFieldsFieldset{static get tag(){return"simple-fields-array"}static get styles(){return[...super.styles,css`
        fieldset {
      ...
      `]}static get properties(){return{...super.properties,count:{type:Number},expanded:{type:Boolean}}}render(){return html` <fieldset>${this.legend}${this.fields}</fieldset> `}get fields(){return html`
      <div id="top">
        ${this.desc}
        <button
          id="expand"
