import{LitElement,html,css}from"../../../lit-element/lit-element.js";import{winEventsElement,camelCaseToDash,wipeSlot,nodeToHaxElement,haxElementToNode,normalizeEventPath}from"../../utils/utils.js";import{HaxSchematizer,HaxElementizer}from"../../hax-body-behaviors/lib/HAXFields.js";import{SimpleTourFinder}from"../../simple-popover/lib/SimpleTourFinder.js";import{HAXStore}from"./hax-store.js";import{autorun,toJS}from"../../../mobx/dist/mobx.esm.js";import"../../simple-fields/simple-fields.js";import"../../simple-popover/simple-popover.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"../../a11y-collapse/lib/a11y-collapse-group.js";import"../../a11y-collapse/a11y-collapse.js";import"./hax-tray-upload.js";import"./hax-gizmo-browser.js";import"./hax-app-browser.js";import"./hax-stax-browser.js";import"./hax-map.js";import"./hax-preferences-dialog.js";class HaxTray extends(SimpleTourFinder(winEventsElement(LitElement))){static get tag(){return"hax-tray"}constructor(){super(),this.tourName="hax",this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel"},this._initial=!0,this.activeValue={settings:{layout:{__position:"hax-align-left",__scale:100},configure:{},advanced:{}}},this.collapsed=!1,this.activeTab="item-0",this.activeSchema=[],this.canUndo=!1,this.canRedo=!1,this.elementAlign="right",this.activeTagName="Select an element to configure",this.activeTagIcon="icons:settings",this.traySizeIcon="hax:arrow-expand-right",this.__setup=!1,this.__tipText="Edit",setTimeout(()=>{import("./hax-tray-button.js"),this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this))},0),autorun(()=>{this.activeGizmo=toJS(HAXStore.activeGizmo)}),autorun(()=>{this.activeNode=toJS(HAXStore.activeNode)}),autorun(()=>{this.globalPreferences=toJS(HAXStore.globalPreferences)}),autorun(()=>{this.editMode=toJS(HAXStore.editMode)})}_expandSettingsPanel(e){this.shadowRoot.querySelector("#settingscollapse").expand()}_redoChanged(e){this.canRedo=e.detail.value}_undoChanged(e){this.canUndo=e.detail.value}static get styles(){return[css`
        :host {
