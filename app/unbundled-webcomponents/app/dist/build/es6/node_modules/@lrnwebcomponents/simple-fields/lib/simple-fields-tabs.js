import{LitElement,html,css}from"../../../lit-element/lit-element.js";import{SimpleFieldsFieldset}from"./simple-fields-fieldset.js";import{A11yTabs}from"../../a11y-tabs/a11y-tabs.js";import"./simple-fields-tab.js";class SimpleFieldsTabs extends A11yTabs{constructor(){super(),this.fullWidth=!0}static get tag(){return"simple-fields-tabs"}static get styles(){return[...super.styles,...SimpleFieldsFieldset.styles,css`
      ...
      `]}static get properties(){return{...super.properties,...SimpleFieldsFieldset.properties}}get tabQuery(){return"simple-fields-tab"}_tabLabel(tab){return html`
      <span class="label${tab.error?" error":""}"
        >${tab.label}${tab.error?"*":""}</span
      >
    `}}window.customElements.define(SimpleFieldsTabs.tag,SimpleFieldsTabs);export{SimpleFieldsTabs};