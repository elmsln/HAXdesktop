 ...
 */
import{LitElement,html,css}from"../../lit-element/lit-element.js";import{ResponsiveUtilityBehaviors}from"../responsive-utility/lib/responsive-utility-behaviors.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"../simple-tooltip/simple-tooltip.js";import"./lib/a11y-tab.js";class A11yTabs extends(ResponsiveUtilityBehaviors(LitElement)){static get styles(){return[css`
        :host {
          display: block;
    ...
    `}_tabFlag(tab){return html`
      <span class="flag-type" ?hidden="${!tab.flag}"> ${tab.flag} </span>
    `}_tabIcon(tab,icon){return tab.flag?html`
          <simple-icon-lite
            class="icon"
            ?hidden="${!tab[icon]}"
            .icon="${tab[icon]}"
        ...
        `}_tabLabel(tab){return html` <span class="label">${tab.label}</span> `}_tabTooltip(tab){return html`
