 ...
 */
import{LitElement,html,css}from"../../../../lit-element/lit-element.js";const RichTextEditorButtonStyles=function(SuperClass){return class extends SuperClass{static get tag(){return"rich-text-editor-button-styles"}static get styles(){return[css`
          :host {
        ...
        `]}}};class RichTextEditorButtonStylesEl extends(RichTextEditorButtonStyles(LitElement)){}window.customElements.define(RichTextEditorButtonStylesEl.tag,RichTextEditorButtonStylesEl);export{RichTextEditorButtonStylesEl,RichTextEditorButtonStyles};