 ...
 */
import{html,css}from"../../../../lit-element/lit-element.js";import{SimpleColors}from"../../simple-colors.js";class simpleColorsSwatchInfo extends SimpleColors{static get styles(){return[...super.styles,css`
        :host {
          display: block;
          margin: 15px 0;
        }
      ...
      >
        ...
        <tbody>
          ${this._getOptions(this.colors).map(color=>html`
              <tr>
                <th scope="row">${color}</th>
                <td>
                  ${this._getAa(this.swatchId,color).map(contrast=>html`
                        <span
                          class="contrast"
                ...
                <td>
                  ${this._getAaLarge(this.swatchId,color).map(contrast=>html`
                        <span
                          class="contrast"
                          style="${this._getContrastBg(color,contrast)}"
                          >${color}-${contrast}</span
