import{LitElement,html,css}from"../../../lit-element/lit-element.js";class SimpleFieldsContainer extends LitElement{static get tag(){return"simple-fields-container"}static get styles(){return[css`
        :host {
          display: block;
          width: 100%;
    ...
    `}get fieldId(){return`${this.id||"field"}.input`}get fieldMainTemplate(){return html`
      <div
    ...
    `}get fieldMeta(){return html`
      <div id="fieldmeta" aria-live="polite">
        <slot name="field-meta"></slot>
      </div>
    `}get hasFieldset(){return"fieldset"===this.type}get labelTemplate(){return html`
      <label
        for="${this.fieldId}"
        class="label-main"
