 ...
 */
import{LitElement,html,css}from"../../lit-element/lit-element.js";import{SimpleColorsSharedStylesGlobal}from"../simple-colors-shared-styles/simple-colors-shared-styles.js";const SimpleColorsSuper=function(SuperClass){return class extends SuperClass{static get styles(){let styles=css("");return super.styles&&(styles=super.styles),[styles,css`
          :host([dark]) {
        ...
        `]}render(){return html` <slot></slot>`}static get properties(){return{...super.properties,accentColor:{attribute:"accent-color",type:String,reflect:!0},dark:{name:"dark",type:Boolean,reflect:!0}}}constructor(){super(),this.accentColor="grey",this.dark=!1,this.colors=SimpleColorsSharedStylesGlobal.colors}static get tag(){return"simple-colors"}invertShade(shade){return SimpleColorsSharedStylesGlobal.invertShade(shade)}getColorInfo(colorName){return SimpleColorsSharedStylesGlobal.getColorInfo(colorName)}makeVariable(color="grey",shade=1,theme="default"){return SimpleColorsSharedStylesGlobal.makeVariable("grey",1,"default")}getContrastingColors(colorName,colorShade,isLarge){return SimpleColorsSharedStylesGlobal.getContrastingColors(colorName,colorShade,isLarge)}getContrastingShades(isLarge,colorName,colorShade,contrastName){return SimpleColorsSharedStylesGlobal.getContrastingShades(isLarge,colorName,colorShade,contrastName)}isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return SimpleColorsSharedStylesGlobal.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}};class SimpleColors extends(SimpleColorsSuper(LitElement)){}window.customElements.define(SimpleColors.tag,SimpleColors);export{SimpleColors,SimpleColorsSuper};