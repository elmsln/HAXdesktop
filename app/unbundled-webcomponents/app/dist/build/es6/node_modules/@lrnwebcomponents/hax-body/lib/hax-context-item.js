import{LitElement,html,css}from"../../../lit-element/lit-element.js";import"./hax-toolbar-item.js";import"../../simple-icon/lib/simple-icon-lite.js";import{HAXStore}from"./hax-store.js";class HaxContextItem extends LitElement{constructor(){super(),this.haxUIElement=!0,this.simple=!1,this.danger=!1,this.light=!1,this.action=!1,this.large=!1,this.disabled=!1,this.more=!1,this.mini=!1,this.menu=!1,this.direction="top",this.icon="editor:text-fields",this.iconClass="",this.label="",this.eventName="button",this.inputMethod=null,this.propertyToBind=null,this.slotToBind=null,this.default=!1,this.value=""}static get styles(){return[css`
        :host {
          display: inline-flex;
        }
        simple-icon-lite {
