import{LitElement,html,css}from"../../../lit-element/lit-element.js";import"../../simple-fields/simple-fields.js";import{HaxSchematizer,HaxElementizer}from"../../hax-body-behaviors/lib/HAXFields.js";class HaxAppSearchInputs extends LitElement{static get styles(){return[css`
        :host {
          display: block;
        }
        simple-fields {
      ...
      `]}updated(changedProperties){super.updated()&&super.updated(changedProperties),changedProperties.forEach((oldValue,propName)=>{"label"==propName&&(this.shadowRoot.querySelector("#form").value={})})}constructor(){super(),this.label="app"}render(){return html`
