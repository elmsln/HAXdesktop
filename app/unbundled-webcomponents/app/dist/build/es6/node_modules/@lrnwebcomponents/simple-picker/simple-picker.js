 ...
 */
import{LitElement,html,css}from"../../lit-element/lit-element.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";class SimplePicker extends LitElement{static get styles(){return[css`
        :host {
        ...
        <div id="collapse">
          <div class="rows">
            ${this.__options?this.__options.map((row,rownum)=>html`
                    <div class="row">
                      ${Array.isArray(row)?row.map((option,colnum)=>html`
                              <simple-picker-option
