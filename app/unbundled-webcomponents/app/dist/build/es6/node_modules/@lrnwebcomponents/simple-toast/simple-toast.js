 ...
 */
import{html,css}from"../../lit-element/lit-element.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import"./lib/simple-toast-el.js";window.SimpleToast=window.SimpleToast||{},window.SimpleToast.requestAvailability=()=>(window.SimpleToast.instance||(window.SimpleToast.instance=document.createElement("simple-toast"),document.body.appendChild(window.SimpleToast.instance)),window.SimpleToast.instance);export const SimpleToastStore=window.SimpleToast.requestAvailability();class SimpleToast extends SimpleColors{static get styles(){return[...super.styles,css`
        :host {
          display: block;
        }
      ...
      `]}render(){return html` <simple-toast-el
      id="toast"
