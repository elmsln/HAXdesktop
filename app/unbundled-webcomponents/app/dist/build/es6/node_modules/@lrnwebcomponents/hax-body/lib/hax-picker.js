import{LitElement,html,css}from"../../../lit-element/lit-element.js";class HaxPicker extends LitElement{static get styles(){return[css`
        :host {
          display: block;
        }
        .button-list {
      ...
      `]}constructor(){super(),this._elements=[],this.selectionList=[],this.pickerType="gizmo"}render(){return html`
      <div class="button-list">
        ${this.selectionList.map((element,index)=>html`
            <hax-tray-button
              dark-bg
