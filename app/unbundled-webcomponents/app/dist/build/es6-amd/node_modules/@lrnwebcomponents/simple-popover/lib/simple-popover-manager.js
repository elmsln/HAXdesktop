define(["exports","../../../lit-element/lit-element.js","../simple-popover.js"],(function(_exports,_litElement,_simplePopover){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SimplePopoverManager=void 0;class SimplePopoverManager extends _litElement.LitElement{constructor(){super(),this.popover=null,this.opened=!1,this.context=null,this.orientation="tb",this.position="bottom",this.__ignore=!1}static get styles(){return[_litElement.css`
        simple-popover {
          font-size: 14px;
          line-height: 20px;
          color: black;
