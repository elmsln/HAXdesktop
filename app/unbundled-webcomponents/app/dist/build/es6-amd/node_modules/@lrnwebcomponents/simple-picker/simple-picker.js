define(["exports","require","../../lit-element/lit-element.js","../simple-icon/lib/simple-icon-lite.js","../simple-icon/lib/simple-icons.js"],(function(_exports,_require,_litElement,_simpleIconLite,_simpleIcons){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SimplePicker=void 0,_require=babelHelpers.interopRequireWildcard(_require);
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class SimplePicker extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
      ...
      `]}render(){return _litElement.html` <label
        id="listLabel"
        for="listbox"
        ...
        <div id="collapse">
          <div class="rows">
            ${this.__options?this.__options.map((row,rownum)=>_litElement.html`
                    <div class="row">
                      ${Array.isArray(row)?row.map((option,colnum)=>_litElement.html`
                              <simple-picker-option
