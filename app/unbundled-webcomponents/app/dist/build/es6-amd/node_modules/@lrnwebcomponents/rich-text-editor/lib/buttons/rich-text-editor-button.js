define(["exports","require","../../../../lit-element/lit-element.js","./rich-text-editor-button-styles.js","../singletons/rich-text-editor-selection.js","../../../simple-icon/lib/simple-icon-lite.js","../../../simple-icon/lib/simple-icons.js","../../../simple-icon/lib/simple-icon-button-lite.js","../../../hax-iconset/lib/simple-hax-iconset.js"],(function(_exports,_require,_litElement,_richTextEditorButtonStyles,_richTextEditorSelection,_simpleIconLite,_simpleIcons,_simpleIconButtonLite,_simpleHaxIconset){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.RichTextEditorButtonBehaviors=_exports.RichTextEditorButton=void 0,_require=babelHelpers.interopRequireWildcard(_require);
/**
   * Copyright 2019 Penn State University
   * @license Apache-2.0, see License.md for full text.
   */
const RichTextEditorButtonBehaviors=function(SuperClass){return class extends((0,_richTextEditorButtonStyles.RichTextEditorButtonStyles)(SuperClass)){firstUpdated(changedProperties){super.firstUpdated&&super.firstUpdated(changedProperties),this.__a11y=this.shadowRoot.querySelector("#button"),this.__a11y.addEventListener("keypress",e=>{switch(e.key){case"Enter":this._buttonTap(e)}})}static get tag(){return"rich-text-editor-button"}static get styles(){return[...super.styles,_litElement.css`
          .rtebutton {
