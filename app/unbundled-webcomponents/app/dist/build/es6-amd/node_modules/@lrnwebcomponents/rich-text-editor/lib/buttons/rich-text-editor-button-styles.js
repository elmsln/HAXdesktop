define(["exports","../../../../lit-element/lit-element.js"],(function(_exports,_litElement){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.RichTextEditorButtonStyles=_exports.RichTextEditorButtonStylesEl=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
const RichTextEditorButtonStyles=function(SuperClass){return class extends SuperClass{static get tag(){return"rich-text-editor-button-styles"}static get styles(){return[_litElement.css`
          :host {
        ...
        `]}}};_exports.RichTextEditorButtonStyles=RichTextEditorButtonStyles;class RichTextEditorButtonStylesEl extends(RichTextEditorButtonStyles(_litElement.LitElement)){}_exports.RichTextEditorButtonStylesEl=RichTextEditorButtonStylesEl,window.customElements.define(RichTextEditorButtonStylesEl.tag,RichTextEditorButtonStylesEl)}));