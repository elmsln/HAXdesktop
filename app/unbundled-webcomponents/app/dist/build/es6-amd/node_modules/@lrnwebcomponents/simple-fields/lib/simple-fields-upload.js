define(["exports","require","../../../lit-element/lit-element.js","../../simple-colors/simple-colors.js","../../simple-picker/simple-picker.js","./simple-fields-field.js","../../../@vaadin/vaadin-upload/vaadin-upload.js"],(function(_exports,_require,_litElement,_simpleColors,_simplePicker,_simpleFieldsField,_vaadinUpload){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SimpleFieldsUpload=void 0,_require=babelHelpers.interopRequireWildcard(_require);class SimpleFieldsUpload extends _simpleColors.SimpleColors{static get tag(){return"simple-fields-upload"}static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
          visibility: visible;
      ...
      `]}constructor(){super(),this.label=null,this.noCamera=!1,this.options=[],this.noVoiceRecord=!0}render(){return _litElement.html`
    ...
    `}optionChanged(e){this.option=e.detail.value,null!=e.detail.value&&"null"!=e.detail.value||this.options&&this.options[0]&&this.options[0][0]&&this.options[0][0].value&&(this.option=this.options[0][0].value)}valueChanged(e){this.value=e.detail.value}updated(changedProperties){super.updated&&super.updated(changedProperties),changedProperties.forEach((oldValue,propName)=>{"value"==propName&&this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this[propName]}}))})}static get properties(){return{label:{type:String},description:{type:String},value:{type:String},option:{type:String},options:{type:Array},noCamera:{type:Boolean,attribute:"no-camera"},noVoiceRecord:{type:Boolean,attribute:"no-voice-record"}}}_fileAboutToUpload(e){this.dispatchEvent(new CustomEvent("upload-before",{bubbles:!0,cancelable:!0,composed:!1,detail:e.detail}))}_fileUploadResponse(e){this.shadowRoot.querySelector("#url").value=item.url,this.dispatchEvent(new CustomEvent("upload-response",{bubbles:!0,cancelable:!0,composed:!1,detail:e.detail}))}_setInputOptions(){let options=[[{alt:"URL",icon:"icons:link",value:"url"}],[{alt:"Upload",icon:"icons:file-upload",value:"fileupload"}]];return!navigator.mediaDevices||this.noCamera?this.shadowRoot.querySelector("#camerahole").style.display="none":options.push([{alt:"Camera",icon:"image:photo-camera",value:"selfie"}]),navigator.mediaDevices&&!this.noVoiceRecord||(this.shadowRoot.querySelector("#voicerecorder").style.display="none"),options}firstUpdated(changedProperties){super.firstUpdated&&super.firstUpdated(changedProperties),this.options=[...this._setInputOptions()],this.value?this.option="url":this.option="fileupload",this.shadowRoot.querySelector("#picker").addEventListener("change",e=>{e&&e.detail&&"selfie"===e.detail.value&&this._takeSelfie(e),e&&e.detail&&"audio"===e.detail.value&&this._voiceRecorder(e)})}__newPhotoShowedUp(e){let file=new File([e.detail.raw],"headshot"+e.timeStamp+".jpg");this.shadowRoot.querySelector("#fileupload")._addFile(file)}__newAudioShowedUp(e){let file=new File([e.detail.value],"voice-memo"+e.timeStamp+".mp3");this.shadowRoot.querySelector("#fileupload")._addFile(file)}_takeSelfie(e){this.camera||(new Promise((res,rej)=>_require.default(["@lrnwebcomponents/simple-login/lib/simple-camera-snap.js"],res,rej)),this.camera=document.createElement("simple-camera-snap"),this.camera.autoplay=!0,this.camera.addEventListener("simple-camera-snap-image",this.__newPhotoShowedUp.bind(this)),this.shadowRoot.querySelector("#camerahole").appendChild(this.camera))}_voiceRecorder(e){this.voice||(new Promise((res,rej)=>_require.default(["../../voice-recorder/voice-recorder.js"],res,rej)),this.voice=document.createElement("voice-recorder"),this.voice.addEventListener("voice-recorder-recording",this.__newAudioShowedUp.bind(this)),this.shadowRoot.querySelector("#voicerecorder").appendChild(this.voice))}_resolveObjectPath(path,obj){return path.split(".").reduce((function(prev,curr){return prev?prev[curr]:null}),obj||self)}}_exports.SimpleFieldsUpload=SimpleFieldsUpload,window.customElements.define(SimpleFieldsUpload.tag,SimpleFieldsUpload)}));