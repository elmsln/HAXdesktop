define(["exports","../../../lit-element/lit-element.js","../../simple-icon/lib/simple-icon-lite.js","../../hax-iconset/lib/simple-hax-iconset.js","./hax-context-item-menu.js","./hax-context-item.js","./hax-context-item-textop.js","./hax-toolbar.js","../../simple-popover/lib/simple-popover-selection.js","../../simple-popover/lib/SimpleTourFinder.js","./hax-store.js","../../../mobx/dist/mobx.esm.js"],(function(_exports,_litElement,_simpleIconLite,_simpleHaxIconset,_haxContextItemMenu,_haxContextItem,_haxContextItemTextop,_haxToolbar,_simplePopoverSelection,_SimpleTourFinder,_haxStore,_mobxEsm){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxTextContext=void 0;class HaxTextContext extends((0,_SimpleTourFinder.SimpleTourFinder)(_litElement.LitElement)){static get styles(){return[_litElement.css`
        :host {
          display: block;
          pointer-events: none;
        }
      ...
      <hax-toolbar id="toolbar">
        ...
        >
          ...
          ${this.formattingList.map(val=>_litElement.html` <button slot="options" value="${val.value}">
    ...
    `}static get tag(){return"hax-text-context"}static get properties(){return{_showIndent:{type:Boolean},_showLists:{type:Boolean},realSelectedValue:{type:String},sourceView:{type:Boolean},formattingList:{type:Array},hasSelectedText:{type:Boolean,attribute:"has-selected-text",reflect:!0},formatIcon:{type:String,attribute:"format-icon"},isSafari:{type:Boolean,attribute:"is-safari"}}}textFormatChanged(e){this.shadowRoot.querySelector("simple-popover-selection").opened=!1,this.updateTextIconSelection(e.detail.getAttribute("value")),this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:{eventName:"text-tag",value:this.realSelectedValue}}))}updateTextIconSelection(tag){this.realSelectedValue=tag,this.shadowRoot.querySelector("[data-simple-popover-selection-active]")&&this.shadowRoot.querySelector("[data-simple-popover-selection-active]").removeAttribute("data-simple-popover-selection-active");let localItem=this.shadowRoot.querySelector('button[value="'+this.realSelectedValue+'"]');localItem&&(localItem.setAttribute("data-simple-popover-selection-active",!0),this.formatIcon=localItem.querySelector("simple-icon-lite").getAttribute("icon"))}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"realSelectedValue"==propName&&(this._showIndent=this._computeShowIndent(this.realSelectedValue),"p"==this.realSelectedValue?this._showLists=!0:this._showLists=!1)})}firstUpdated(changedProperties){super.firstUpdated&&super.firstUpdated(changedProperties),(0,_mobxEsm.toJS)(_haxStore.HAXStore.activeNode)&&(0,_mobxEsm.toJS)(_haxStore.HAXStore.activeNode).tagName&&this.updateTextIconSelection((0,_mobxEsm.toJS)(_haxStore.HAXStore.activeNode).tagName.toLowerCase())}_computeShowIndent(realSelectedValue){return!(!_haxStore.HAXStore.computePolyfillSafe()||"li"!=realSelectedValue&&"ol"!=realSelectedValue&&"ul"!=realSelectedValue)}_haxInMenuContextOperation(e){let prevent=!1;switch(e.detail.eventName){case"insert-above-active":case"insert-below-active":this.shadowRoot.querySelector("simple-popover-selection").opened=!1;break;case"text-underline":document.execCommand("underline"),prevent=!0;break;case"text-subscript":document.execCommand("subscript"),prevent=!0;break;case"text-superscript":document.execCommand("superscript"),prevent=!0;break;case"text-strikethrough":document.execCommand("strikeThrough"),prevent=!0}prevent&&(this.shadowRoot.querySelector("simple-popover-selection").opened&&(this.shadowRoot.querySelector("simple-popover-selection").opened=!1),e.preventDefault(),e.stopPropagation())}_haxContextOperation(e){let detail=e.detail,selection=_haxStore.HAXStore.getSelection(),prevent=!1;switch(detail.eventName){case"insert-inline-gizmo":if(_haxStore.HAXStore._tmpSelection&&_haxStore.HAXStore.editMode)try{"HAX-BODY"!==_haxStore.HAXStore._tmpRange.startContainer.parentNode.parentNode.tagName&&"HAX-BODY"!==_haxStore.HAXStore._tmpRange.startContainer.parentNode.parentNode.parentNode.tagName||(_haxStore.HAXStore.activePlaceHolder=_haxStore.HAXStore._tmpRange)}catch(err){}if(null!=_haxStore.HAXStore.activePlaceHolder){let values={text:_haxStore.HAXStore.activePlaceHolder.toString()},type="inline",haxElements=_haxStore.HAXStore.guessGizmo(type,values);haxElements.length>0&&_haxStore.HAXStore.haxAppPicker.presentOptions(haxElements,type,"Transform selected text to..","gizmo")}break;case"text-bold":document.execCommand("bold"),prevent=!0;break;case"text-italic":document.execCommand("italic"),prevent=!0;break;case"text-remove-format":document.execCommand("removeFormat"),prevent=!0;break;case"text-link":var href="";selection&&selection.focusNode&&selection.focusNode.parentNode&&void 0!==selection.focusNode.parentNode.href&&(href=selection.focusNode.parentNode.href);let url=prompt("Enter a URL:",href);url&&(document.execCommand("createLink",!1,url),selection.focusNode.parentNode&&(selection.focusNode.parentNode.setAttribute("contenteditable",!0),selection.focusNode.parentNode.removeEventListener("click",e=>{e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation()}),selection.focusNode.parentNode.addEventListener("click",e=>{e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation()})),prevent=!0);break;case"text-unlink":document.execCommand("unlink"),prevent=!0;break;case"text-indent":_haxStore.HAXStore.activeHaxBody.__indentTrap=!0,document.execCommand("indent"),prevent=!0;break;case"text-outdent":_haxStore.HAXStore.activeHaxBody.__indentTrap=!0,document.execCommand("outdent"),prevent=!0}prevent&&(e.preventDefault(),e.stopPropagation())}_isSafari(){let ua=navigator.userAgent.toLowerCase();return!(-1==ua.indexOf("safari")||ua.indexOf("chrome")>-1)}}_exports.HaxTextContext=HaxTextContext,window.customElements.define(HaxTextContext.tag,HaxTextContext)}));