define(["exports","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../intersection-element/lib/IntersectionObserverMixin.js"],(function(_exports,_litElement,_simpleColors,_IntersectionObserverMixin){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.AccentCard=void 0;
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class AccentCard extends((0,_IntersectionObserverMixin.IntersectionObserverMixin)(_simpleColors.SimpleColors)){static get tag(){return"accent-card"}static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
          border-radius: 2px;
          margin: 0 0 15px;
      ...
      <article id="card">
        ...
        >
          <div
            class="image"
            .style="${this.elementVisible&&this.imageSrc?`background-image: url(${this.imageSrc});`:""}"
          ></div>
    ...
    `}static get haxProperties(){return{canEditSource:!0,canPosition:!1,canEditSource:!0,gizmo:{title:"Accent Card",description:"A card with optional accent styling.",icon:"chrome-reader-mode",color:"light-blue",groups:["Media","Content","Image","Presentation"],handles:[{type:"media",url:"source"},{type:"image",source:"imageSrc"},{type:"text",url:"source"}],meta:{author:"nikkimk",owner:"The Pennsylvania State University"}},settings:{configure:[{slot:"heading",title:"Heading",description:"A heading for card.",inputMethod:"textfield"},{slot:"subheading",title:"Subheading",description:"An optional subheading for card.",inputMethod:"textfield"},{slot:"content",title:"Content",description:"Content for card.",inputMethod:"textfield"},{slot:"footer",title:"Footer",description:"An optional footer for card.",inputMethod:"textfield"},{property:"imageSrc",title:"Image",description:"Optional image",inputMethod:"haxupload",icon:"editor:insert-photo"},{property:"imageAlign",title:"imageAlign",description:"Image Horizontal Alignment",inputMethod:"select",options:{left:"left",center:"center",right:"right"}},{property:"imageValign",title:"imageValign",description:"Image Vertical Alignment",inputMethod:"select",options:{top:"top",center:"center",bottom:"bottom"}},{property:"accentColor",title:"Accent Color",description:"An optional accent color.",inputMethod:"colorpicker",icon:"editor:format-color-fill"},{property:"dark",title:"Dark Theme",description:"Enable Dark Theme",inputMethod:"boolean",icon:"icons:invert-colors"},{property:"horizontal",title:"Horizontal",description:"Horizontal orientation?",inputMethod:"boolean"},{property:"accentHeading",title:"Heading Accent",description:"Apply accent color to heading?",inputMethod:"boolean"},{property:"accentBackground",title:"Background Accent",description:"Apply accent color to card background?",inputMethod:"boolean"},{property:"noBorder",title:"No Border Accent",description:"Remove border accent?",inputMethod:"boolean"},{property:"flat",title:"Flat",description:"Remove box shadow?",inputMethod:"boolean"}],advanced:[]},demoSchema:[{tag:"accent-card",properties:{style:"maxWidth:600px;width:100%;",accentColor:"cyan",dark:!0,imageSrc:"http://placekitten.com/200/600"},content:'<span slot="heading">Card Heading</span>\n<p slot="content">This is the body of the card.</p>'}],saveOptions:{unsetAttributes:["colors","element-visible"]}}}constructor(){super(),this.accentBackground=!1,this.accentHeading=!1,this.flat=!1,this.horizontal=!1,this.imageAlign=null,this.imageSrc=null,this.imageValign=null,this.noBorder=!1}static get properties(){return{...super.properties,accentBackground:{type:Boolean,attribute:"accent-background",reflect:!0},accentHeading:{type:Boolean,attribute:"accent-heading",reflect:!0},flat:{type:Boolean,reflect:!0},horizontal:{type:Boolean,reflect:!0},imageAlign:{type:String,attribute:"image-align",reflect:!0},imageSrc:{type:String,attribute:"image-src"},imageValign:{type:String,attribute:"image-valign",reflect:!0},noBorder:{type:Boolean,attribute:"no-border",reflect:!0}}}}_exports.AccentCard=AccentCard,window.customElements.define(AccentCard.tag,AccentCard)}));