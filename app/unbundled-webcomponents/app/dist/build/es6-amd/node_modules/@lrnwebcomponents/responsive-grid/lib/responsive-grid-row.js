define(["exports","../../../lit-element/lit-element.js","../../responsive-utility/responsive-utility.js","./responsive-grid-col.js","./responsive-grid-clear.js"],(function(_exports,_litElement,_responsiveUtility,_responsiveGridCol,_responsiveGridClear){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.ResponsiveGridRow=void 0;class ResponsiveGridRow extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
          display: block;
          width: 100%;
          margin-right: auto;
    ...
    `}static get tag(){return"responsive-grid-row"}constructor(){super(),this.xl=null,this.lg=null,this.md=null,this.sm=null,this.xs=null,this.gutter=0,this.responsiveToParent=!1,this.screen="xs",window.ResponsiveUtility.requestAvailability()}firstUpdated(){this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:this,attribute:"screen",relativeToParent:this.responsiveToParent}}))}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"screen"==propName&&this.dispatchEvent(new CustomEvent("screen-changed",{detail:{value:this[propName]}}))})}static get properties(){return{xs:{type:Number},sm:{type:Number},md:{type:Number},lg:{type:Number},xl:{type:Number},gutter:{type:Number},responsiveToParent:{type:Boolean,reflect:!0,attribute:"responsive-to-parent"},screen:{type:String,reflect:!0}}}}_exports.ResponsiveGridRow=ResponsiveGridRow,window.customElements.define(ResponsiveGridRow.tag,ResponsiveGridRow)}));