define(["exports","../../../lit-element/lit-element.js","../../simple-tooltip/simple-tooltip.js","../../simple-icon/lib/simple-icon-lite.js","../../hax-iconset/lib/simple-hax-iconset.js"],(function(_exports,_litElement,_simpleTooltip,_simpleIconLite,_simpleHaxIconset){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxToolbarItem=void 0;class HaxToolbarItem extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
          display: flex;
    ...
    `}static get tag(){return"hax-toolbar-item"}constructor(){super(),this.simple=!1,this.circle=!1,this.corner="",this.large=!1,this.disabled=!1,this.dark=!1,this.danger=!1,this.menu=!1,this.mini=!1,this.icon="",this.label="",this.tooltip="",this.tooltipDirection="top",this.default=!1}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"height"==propName&&this.shadowRoot&&(this.shadowRoot.querySelector("#btn").style.height=this[propName])})}static get properties(){return{corner:{type:String,reflect:!0},circle:{type:Boolean,reflect:!0},height:{type:String},disabled:{type:Boolean,reflect:!0},dark:{type:Boolean,reflect:!0},danger:{type:Boolean,reflect:!0},menu:{type:Boolean,reflect:!0},mini:{type:Boolean,reflect:!0},large:{type:Boolean,reflect:!0},icon:{type:String},label:{type:String},tooltip:{type:String},tooltipDirection:{type:String,attribute:"tooltip-direction"},default:{type:Boolean,reflect:!0}}}}_exports.HaxToolbarItem=HaxToolbarItem,window.customElements.define(HaxToolbarItem.tag,HaxToolbarItem)}));