define(["exports","../../lit-element/lit-element.js","../simple-colors-shared-styles/simple-colors-shared-styles.js"],(function(_exports,_litElement,_simpleColorsSharedStyles){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SimpleColorsSuper=_exports.SimpleColors=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
const SimpleColorsSuper=function(SuperClass){return class extends SuperClass{static get styles(){let styles=(0,_litElement.css)("");return super.styles&&(styles=super.styles),[styles,_litElement.css`
          :host([dark]) {
        ...
        `]}render(){return _litElement.html` <slot></slot>`}static get properties(){return{...super.properties,accentColor:{attribute:"accent-color",type:String,reflect:!0},dark:{name:"dark",type:Boolean,reflect:!0}}}constructor(){super(),this.accentColor="grey",this.dark=!1,this.colors=_simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.colors}static get tag(){return"simple-colors"}invertShade(shade){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.invertShade(shade)}getColorInfo(colorName){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getColorInfo(colorName)}makeVariable(color="grey",shade=1,theme="default"){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.makeVariable("grey",1,"default")}getContrastingColors(colorName,colorShade,isLarge){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getContrastingColors(colorName,colorShade,isLarge)}getContrastingShades(isLarge,colorName,colorShade,contrastName){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getContrastingShades(isLarge,colorName,colorShade,contrastName)}isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}};_exports.SimpleColorsSuper=SimpleColorsSuper;class SimpleColors extends(SimpleColorsSuper(_litElement.LitElement)){}_exports.SimpleColors=SimpleColors,window.customElements.define(SimpleColors.tag,SimpleColors)}));