define(["exports","require","../../../lit-element/lit-element.js","../../utils/utils.js","../../hax-body-behaviors/lib/HAXFields.js","../../simple-popover/lib/SimpleTourFinder.js","./hax-store.js","../../../mobx/dist/mobx.esm.js","../../simple-fields/simple-fields.js","../../simple-popover/simple-popover.js","../../simple-icon/lib/simple-icon-lite.js","../../simple-icon/lib/simple-icons.js","../../hax-iconset/lib/simple-hax-iconset.js","../../a11y-collapse/lib/a11y-collapse-group.js","../../a11y-collapse/a11y-collapse.js","./hax-tray-upload.js","./hax-gizmo-browser.js","./hax-app-browser.js","./hax-stax-browser.js","./hax-map.js","./hax-preferences-dialog.js"],(function(_exports,_require,_litElement,_utils,_HAXFields,_SimpleTourFinder,_haxStore,_mobxEsm,_simpleFields,_simplePopover,_simpleIconLite,_simpleIcons,_simpleHaxIconset,_a11yCollapseGroup,_a11yCollapse,_haxTrayUpload,_haxGizmoBrowser,_haxAppBrowser,_haxStaxBrowser,_haxMap,_haxPreferencesDialog){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxTray=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxTray extends((0,_SimpleTourFinder.SimpleTourFinder)((0,_utils.winEventsElement)(_litElement.LitElement))){static get tag(){return"hax-tray"}constructor(){super(),this.tourName="hax",this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel"},this._initial=!0,this.activeValue={settings:{layout:{__position:"hax-align-left",__scale:100},configure:{},advanced:{}}},this.collapsed=!1,this.activeTab="item-0",this.activeSchema=[],this.canUndo=!1,this.canRedo=!1,this.elementAlign="right",this.activeTagName="Select an element to configure",this.activeTagIcon="icons:settings",this.traySizeIcon="hax:arrow-expand-right",this.__setup=!1,this.__tipText="Edit",setTimeout(()=>{new Promise((res,rej)=>_require.default(["./hax-tray-button.js"],res,rej)),this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this))},0),(0,_mobxEsm.autorun)(()=>{this.activeGizmo=(0,_mobxEsm.toJS)(_haxStore.HAXStore.activeGizmo)}),(0,_mobxEsm.autorun)(()=>{this.activeNode=(0,_mobxEsm.toJS)(_haxStore.HAXStore.activeNode)}),(0,_mobxEsm.autorun)(()=>{this.globalPreferences=(0,_mobxEsm.toJS)(_haxStore.HAXStore.globalPreferences)}),(0,_mobxEsm.autorun)(()=>{this.editMode=(0,_mobxEsm.toJS)(_haxStore.HAXStore.editMode)})}_expandSettingsPanel(e){this.shadowRoot.querySelector("#settingscollapse").expand()}_redoChanged(e){this.canRedo=e.detail.value}_undoChanged(e){this.canUndo=e.detail.value}static get styles(){return[_litElement.css`
        :host {
      ...
      ${this.hidePanelOps?"":_litElement.html`
            <hax-tray-button
    ...
    `}__simpleFieldsClick(e){try{this.activeTab=this.shadowRoot.querySelector("#settingsform").shadowRoot.querySelector("simple-fields").activeTab}catch(e){this.activeTab="item-0"}}_refreshAddData(e){this.shadowRoot.querySelector("#gizmobrowser").resetList((0,_mobxEsm.toJS)(_haxStore.HAXStore.gizmoList)),this.shadowRoot.querySelector("#staxbrowser").staxList=[...(0,_mobxEsm.toJS)(_haxStore.HAXStore.staxList)]}_processTrayEvent(e){var target=(0,_utils.normalizeEventPath)(e)[0];switch(e.detail.eventName){case"insert-stax":this.shadowRoot.querySelector("#settingscollapse").expand(),this.dispatchEvent(new CustomEvent("hax-insert-content-array",{bubbles:!0,cancelable:!0,composed:!0,detail:target.stax}));break;case"insert-tag":let haxElement,gizmo={tag:e.detail.value},schema=_haxStore.HAXStore.haxSchemaFromTag(e.detail.value);if(target.getAttribute("data-demo-schema")&&schema&&schema.demoSchema&&schema.demoSchema)haxElement=schema.demoSchema[0];else{let properties=JSON.parse(target.getAttribute("event-properties")),innerContent=target.getAttribute("event-content");null==properties&&(properties={}),null==innerContent&&(innerContent=""),haxElement=_haxStore.HAXStore.haxElementPrototype(gizmo,properties,innerContent)}this.shadowRoot.querySelector("#settingscollapse").expand(),this.dispatchEvent(new CustomEvent("hax-insert-content",{bubbles:!0,cancelable:!0,composed:!0,detail:haxElement}));break;case"open-preferences":this.shadowRoot.querySelector("simple-popover[for='mapbtn']").hidden=!0,this.shadowRoot.querySelector("simple-popover[for='prefbtn']").hidden=!this.shadowRoot.querySelector("simple-popover[for='prefbtn']").hidden,this.shadowRoot.querySelector("hax-preferences-dialog").reloadPreferencesForm();break;case"toggle-element-align":this.elementAlign="right"===this.elementAlign?"left":"right";break;case"toggle-tray-size":this.collapsed=!this.collapsed;break;case"open-map":this.shadowRoot.querySelector("simple-popover[for='prefbtn']").hidden=!0,this.shadowRoot.querySelector("simple-popover[for='mapbtn']").hidden=!this.shadowRoot.querySelector("simple-popover[for='mapbtn']").hidden,this.shadowRoot.querySelector("hax-map").updateHAXMap();break;case"start-tour":window.SimpleTourManager.requestAvailability().startTour("hax");break;case"undo":_haxStore.HAXStore.activeHaxBody.undo();break;case"redo":_haxStore.HAXStore.activeHaxBody.redo();break;case"cancel":confirm("Changes have not been saved, Click OK to close HAX or Cancel to continue editing.")&&(_haxStore.HAXStore.editMode=!1,this.dispatchEvent(new CustomEvent("hax-cancel",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail})))}}static get properties(){return{...super.properties,__tipText:{type:String},menuAlignName:{type:String},offsetMargin:{type:String,attribute:"offset-margin"},collapsed:{type:Boolean,reflect:!0},traySizeIcon:{type:String},traySizeText:{type:String},activeValue:{type:Object},activeSchema:{type:Object},elementAlign:{type:String,reflect:!0,attribute:"element-align"},light:{type:Boolean,reflect:!0},canUndo:{type:Boolean,attribute:"can-undo"},canRedo:{type:Boolean,attribute:"can-redo"},hidePreferencesButton:{type:Boolean,reflect:!0,attribute:"hide-preferences-button"},hidePanelOps:{type:Boolean,reflect:!0,attribute:"hide-panel-ops"},globalPreferences:{type:Object},activeNode:{type:Object},activeTagIcon:{type:String},activeTagName:{type:String},activeGizmo:{type:Object},editMode:{type:Boolean,reflect:!0,attribute:"edit-mode"}}}firstUpdated(changedProperties){super.firstUpdated&&super.firstUpdated(changedProperties),this.__setup||(this.shadowRoot.querySelector("#settingsform").schematizer=_HAXFields.HaxSchematizer,this.shadowRoot.querySelector("#settingsform").elementizer=_HAXFields.HaxElementizer,setTimeout(()=>{this.shadowRoot.querySelector(".wrapper").style.margin=this.offsetMargin},1e3),this.__setup=!0,this.shadowRoot.querySelector("#settingsform").addEventListener("click",this.__simpleFieldsClick.bind(this)),this.shadowRoot.querySelector("#settingsform").addEventListener("value-changed",this.__valueChangedEvent.bind(this)),this.dispatchEvent(new CustomEvent("hax-register-core-piece",{bubbles:!0,cancelable:!0,composed:!0,detail:{piece:"haxTray",object:this}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) add content (menu)",context:this.shadowRoot.querySelector('#addcollapse div[slot="heading"]'),callback:"click"}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) element settings (menu)",context:this.shadowRoot.querySelector('#settingscollapse div[slot="heading"]'),callback:"click"}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) search (menu)",context:this.shadowRoot.querySelector('#searchapps div[slot="heading"]'),callback:"click"}})))}updated(changedProperties){super.updated&&super.updated(changedProperties),changedProperties.forEach((oldValue,propName)=>{"editMode"==propName&&(this.editMode&&_haxStore.HAXStore.refreshActiveNodeForm(),this._editModeChanged(this.editMode)),"offsetMargin"==propName&&setTimeout(()=>{this.shadowRoot.querySelector(".wrapper").style.margin=this.offsetMargin},0),"collapsed"==propName&&(this[propName]?(this.traySizeIcon="hax:arrow-expand-left",this.traySizeText="Expand",this.shadowRoot.querySelector("a11y-collapse-group").setAttribute("aria-disabled","true"),this.shadowRoot.querySelector("a11y-collapse-group").setAttribute("tabindex","-1"),this._editModeChanged(this.editMode)):(this.traySizeIcon="hax:arrow-expand-right",this.traySizeText="Collapse",this.shadowRoot.querySelector("a11y-collapse-group").removeAttribute("aria-disabled"),this.shadowRoot.querySelector("a11y-collapse-group").removeAttribute("tabindex"))),"elementAlign"==propName&&("left"==this[propName]?this.menuAlignName="Right align menu":this.menuAlignName="Left align menu"),"activeGizmo"==propName&&(this.activeGizmo?(this.activeTagName=this.activeGizmo.title+" Settings",this.activeTagIcon=this.activeGizmo.icon,oldValue||this.shadowRoot.querySelector("#settingscollapse").expanded||this.shadowRoot.querySelector('#settingscollapse div[slot="heading"]').click()):(this.activeTagName="Select an element",this.activeTagIcon="icons:settings",this.shadowRoot.querySelector("#addcollapse").expanded||this.shadowRoot.querySelector('#addcollapse div[slot="heading"]').click())),"activeNode"==propName&&(this.activeNode&&this.activeNode.tagName?(this.shadowRoot.querySelector("#settingscollapse").disabled=!1,this.editMode&&_haxStore.HAXStore.refreshActiveNodeForm()):(this.activeTagName="Select an element to configure",this.activeTagIcon="icons:settings",this.shadowRoot.querySelector("#settingscollapse").disabled=!0))})}_setupForm(){let activeNode=this.activeNode;if(this._initial=!0,this.activeValue={settings:{layout:{__position:"hax-align-left",__scale:100},configure:{},advanced:{}}},this.shadowRoot.querySelector("#settingsform").fields=[],this.shadowRoot.querySelector("#settingsform").value={},activeNode.tagName&&_haxStore.HAXStore.elementList[activeNode.tagName.toLowerCase()]){let props=_haxStore.HAXStore.elementList[activeNode.tagName.toLowerCase()];for(var property in void 0===props.gizmo.title?this.humanName=activeNode.tagName.replace("-"," ").toLowerCase():this.humanName=props.gizmo.title,this.activeHaxElement.properties)props.settings.configure.forEach(el=>{el.property===property&&(this.activeValue.settings.configure[property]=this.activeHaxElement.properties[property]),el.attribute===property&&(this.activeValue.settings.configure[property]=this.activeHaxElement.properties[property]),el.slot===property&&(this.activeValue.settings.configure[property]=this.activeHaxElement.properties[property])}),props.settings.advanced.forEach(el=>{el.property===property&&(this.activeValue.settings.advanced[property]=this.activeHaxElement.properties[property]),el.attribute===property&&(this.activeValue.settings.advanced[property]=this.activeHaxElement.properties[property]),el.slot===property&&(this.activeValue.settings.advanced[property]=this.activeHaxElement.properties[property])});let tmp=document.createElement("div");tmp.innerHTML=this.activeHaxElement.content,tmp.childNodes.forEach(el=>{1===el.nodeType&&"undefined"!==el.innerHTML&&(props.settings.configure.forEach(prop=>{prop.slot===el.getAttribute("slot")?this.activeValue.settings.configure[prop.slot]=el.innerHTML:""!=prop.slot||null!=el.getAttribute("slot")&&"null"!=el.getAttribute("slot")||(this.activeValue.settings.configure[prop.slot]=el.innerHTML)}),props.settings.advanced.forEach(prop=>{prop.slot===el.getAttribute("slot")?this.activeValue.settings.advanced[prop.slot]=el.innerHTML:""!=prop.slot||null!=el.getAttribute("slot")&&"null"!=el.getAttribute("slot")||(this.activeValue.settings.advanced[prop.slot]=el.innerHTML)}))}),""!=activeNode.style.width?this.activeValue.settings.layout.__scale=activeNode.style.width.replace("%",""):this.activeValue.settings.layout.__scale=100,"block"==activeNode.style.display&&"0px auto"==activeNode.style.margin&&"right"==activeNode.style.float?this.activeValue.settings.layout.__position="hax-align-right":"block"==activeNode.style.display&&"0px auto"==activeNode.style.margin?this.activeValue.settings.layout.__position="hax-align-center":this.activeValue.settings.layout.__position="hax-align-left",this.activeHaxElement.properties.__scale=this.activeValue.settings.layout.__scale,this.activeHaxElement.properties.__position=this.activeValue.settings.layout.__position,props.settings.configure.forEach((val,key)=>{props.settings.configure[key].attribute&&(props.settings.configure[key].property=props.settings.configure[key].attribute),props.settings.configure[key].slot&&(props.settings.configure[key].property=props.settings.configure[key].slot)}),props.settings.advanced.forEach((val,key)=>{props.settings.advanced[key].attribute&&(props.settings.advanced[key].property=props.settings.advanced[key].attribute),props.settings.advanced[key].slot&&(props.settings.advanced[key].property=props.settings.advanced[key].slot)}),props.settings.layout=[],props.canPosition&&props.settings.layout.push({property:"__position",title:"Alignment",description:"Align content relative to other content",inputMethod:"select",value:this.activeValue.settings.layout.__position,options:{"hax-align-left":"Left","hax-align-center":"Center","hax-align-right":"Right"}}),props.canScale&&props.settings.layout.push({property:"__scale",title:"Width",description:"Scale and resize content",inputMethod:"slider",value:this.activeValue.settings.layout.__scale,min:props.canScale.min?props.canScale.min:12.5,max:props.canScale.max?props.canScale.max:100,step:props.canScale.step?props.canScale.step:12.5}),this.activeSchema=[{property:"settings",inputMethod:"tabs",properties:[]}];props.settings.configure.length>0?this.activeSchema[0].properties.push({property:"configure",title:"Configure",description:"Configure the element",properties:props.settings.configure}):this.activeSchema[0].properties.push({property:"configure",title:"Configure",description:"Configure the element",disabled:!0}),props.settings.layout.length>0?this.activeSchema[0].properties.push({property:"layout",title:"Layout",description:"Position the element relative to other items",properties:props.settings.layout}):this.activeSchema[0].properties.push({property:"layout",title:"Layout",description:"Position the element relative to other items",disabled:!0}),props.settings.advanced.length>0?this.activeSchema[0].properties.push({property:"advanced",title:"Advanced",description:"Advanced element settings",properties:props.settings.advanced}):this.activeSchema[0].properties.push({property:"advanced",title:"Advanced",description:"Advanced element settings",disabled:!0}),this.__activePropSchema=props,this.shadowRoot.querySelector("#settingsform").fields=this.activeSchema,this.shadowRoot.querySelector("#settingsform").value=this.activeValue}}_toArray(obj){return null==obj?[]:Object.keys(obj).map((function(key){return obj[key]}))}__valueChangedEvent(e){if(this.editMode&&e.detail.value&&e.detail.value.settings){let settings=e.detail.value.settings,settingsKeys={advanced:"advanced",configure:"configure",layout:"layout"};var setAhead;for(let key in settingsKeys)for(let prop in settings[key])if(setAhead=!1,null==settings[key][prop]||settings[key][prop].readOnly)this.activeNode.removeAttribute((0,_utils.camelCaseToDash)(prop));else{if("prefix"===prop&&""!=settings[key][prop])this.activeNode.setAttribute("prefix",settings[key][prop]),setAhead=!0;else if("layout"===key&&"__position"===prop)setAhead=!0,this._initial||(clearTimeout(this.__contextValueDebounce),this.__contextValueDebounce=setTimeout(()=>{this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:settings[key][prop],value:settings[key][prop]}}))},50));else if("layout"===key&&"__scale"===prop)setAhead=!0,this._initial||(clearTimeout(this.__contextSizeDebounce),this.__contextSizeDebounce=setTimeout(()=>{this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:"hax-size-change",value:settings[key][prop]}}))},50));else if(this.activeNode.hasOwnProperty(prop)||this.activeNode.properties&&this.activeNode.properties.hasOwnProperty(prop)||null!=settings[key][prop]&&settings[key][prop].constructor===Array||null!=settings[key][prop]&&settings[key][prop].constructor===Object)try{settings[key][prop].constructor===Array?this.activeNode[prop]=[...settings[key][prop]]:settings[key][prop].constructor===Object?this.activeNode[prop]={...settings[key][prop]}:this.activeNode[prop]=settings[key][prop],setAhead=!0}catch(e){console.warn(e),setAhead=!1}else for(var propTmp in this.__activePropSchema.settings[key])if(this.__activePropSchema.settings[key][propTmp].slot==prop){let slotTag="span";this.__activePropSchema.settings[key][propTmp].slotWrapper?slotTag=this.__activePropSchema.settings[key][propTmp].slotWrapper:"code-editor"===this.activeNode.tagName.toLowerCase()&&(slotTag="template");var tmpel=document.createElement(slotTag);if(this.__activePropSchema.settings[key][propTmp].slotAttributes)for(var attr in this.__activePropSchema.settings[key][propTmp].slotAttributes)tmpel.setAttribute(attr,this.__activePropSchema.settings[key][propTmp].slotAttributes[attr]);""!==this.__activePropSchema.settings[key][propTmp].slot&&(tmpel.slot=this.__activePropSchema.settings[key][propTmp].slot),tmpel.innerHTML=settings[key][prop];const cloneIt=tmpel.cloneNode(!0);setAhead=!0,_haxStore.HAXStore.isTextElement(this.activeNode)?this.activeNode.innerHTML=tmpel.innerHTML:((0,_utils.wipeSlot)(this.activeNode,this.__activePropSchema.settings[key][propTmp].slot),this.activeNode.appendChild(cloneIt))}if(!setAhead)try{!0===settings[key][prop]?this.activeNode.setAttribute((0,_utils.camelCaseToDash)(prop),(0,_utils.camelCaseToDash)(prop)):!1===settings[key][prop]||""===settings[key][prop]?this.activeNode.removeAttribute((0,_utils.camelCaseToDash)(prop)):this.activeNode.setAttribute((0,_utils.camelCaseToDash)(prop),settings[key][prop])}catch(e){console.warn(e),console.warn(prop,settings[key][prop])}}}setTimeout(()=>{this._initial&&(this._initial=!1)},51)}_editModeChanged(newValue){newValue?(this.__tipText="Save",this.shadowRoot.querySelector("#button").icon="save"):(this.__tipText="Edit",this.shadowRoot.querySelector("#button").icon="create")}_clickEditButton(e){_haxStore.HAXStore.editMode=!0,window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}_clickSaveButton(e){_haxStore.HAXStore.editMode=!1,this.dispatchEvent(new CustomEvent("hax-save",{bubbles:!0,cancelable:!0,composed:!0,detail:e.detail})),window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}}_exports.HaxTray=HaxTray,window.customElements.define(HaxTray.tag,HaxTray)}));